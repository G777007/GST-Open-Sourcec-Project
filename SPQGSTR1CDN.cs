...
{
    public partial class SPQGSTR1CDN : Form
    {
        ...
        private void GetData()
        {
            try
            {
                ...
                DataTable dt = new DataTable();
                //string Query = "Select * from SPQR1CDN where Fld_Month='" + CommonHelper.SelectedMonth + "' and Fld_FileStatus != 'Total'";
                string Query = "Select Fld_Sequence,Fld_GSTIN,Fld_PartyName,Fld_TypeOfNote,Fld_PreGST,Fld_DbtCrdtNoteNo,Fld_DbtCrdtNoteDate,Fld_OrgInvoiceNo,Fld_OrginvoiceDate,Fld_OrgInvoiceValue,Fld_Rate,Fld_Taxable,Fld_IGSTAmnt,Fld_CGSTAmnt,Fld_SGSTAmnt,Fld_CessAmnt,Fld_PlaceOfSupply,Fld_FileStatus,Fld_Month from SPQR1CDN where Fld_Month='" + CommonHelper.SelectedMonth + "' AND Fld_FinancialYear = '" + CommonHelper.ReturnYear + "' and Fld_FileStatus != 'Total'";
                ...
                if (dgvGSTR27Other.Rows.Count > 1)
                {
                    ...
                    if (dgvGSTR27OtherTotal.Rows.Count == 0)
                    {
                       ...
                       .ToList();
                        ...
                        dr["colTOrginvoiceValue"] = Utility.DisplayIndianCurrency(Convert.ToString(invval));
                        dr["colTTaxable"] = Utility.DisplayIndianCurrency(Convert.ToString(tax));
                        dr["colTIGSTAmnt"] = Utility.DisplayIndianCurrency(Convert.ToString(igst));
                        dr["colTCGSTAmnt"] = Utility.DisplayIndianCurrency(Convert.ToString(cgst));
                        dr["colTSGSTAmnt"] = Utility.DisplayIndianCurrency(Convert.ToString(sgst));
                        dr["colTCESSAmnt"] = Utility.DisplayIndianCurrency(Convert.ToString(cess));
                       ...
                       .ToList();
                        ...
                        foreach (var item in colNo)
                        {
                            if (item == "colDbtCrdtNoteNo")
                                ...
                                dgvGSTR27OtherTotal.Rows[0].Cells["colTOrginvoiceValue"].Value = Utility.DisplayIndianCurrency(Convert.ToString(invval));
                            else if (item == "colTaxable")
                                dgvGSTR27OtherTotal.Rows[0].Cells["colTTaxable"].Value = Utility.DisplayIndianCurrency(Convert.ToString(tax));
                            else if (item == "colIGSTAmnt")
                                dgvGSTR27OtherTotal.Rows[0].Cells["colTIGSTAmnt"].Value = Utility.DisplayIndianCurrency(Convert.ToString(igst));
                            else if (item == "colCGSTAmnt")
                                dgvGSTR27OtherTotal.Rows[0].Cells["colTCGSTAmnt"].Value = Utility.DisplayIndianCurrency(Convert.ToString(cgst));
                            else if (item == "colSGSTAmnt")
                                dgvGSTR27OtherTotal.Rows[0].Cells["colTSGSTAmnt"].Value = Utility.DisplayIndianCurrency(Convert.ToString(sgst));
                            else if (item == "colCessAmnt")
                                dgvGSTR27OtherTotal.Rows[0].Cells["colTCESSAmnt"].Value = Utility.DisplayIndianCurrency(Convert.ToString(cess));
                        }
                        #endregion
                    }
                                                        ...
                                                        if (oCell.ColumnIndex >= 2 && oCell.ColumnIndex <= 17)
                                                        {
                                                            if (chkCellValue(sCells[i].Trim(), dgvGSTR27Other.Columns[oCell.ColumnIndex].Name))
                                                            {
                                                                if (dgvGSTR27Other.Columns[oCell.ColumnIndex].Name == "colTypeOfNote")
                                                                    dgvGSTR27Other.Rows[iRow].Cells[oCell.ColumnIndex].Value = Utility.StrCDN1TypesofNote(sCells[i]);
                                                                //else if (dgvGSTR27Other.Columns[oCell.ColumnIndex].Name == "colReason")
                                                                //    dgvGSTR27Other.Rows[iRow].Cells[oCell.ColumnIndex].Value = Utility.StrCDN1Reasonissuing(sCells[i]);
                                                                else if (dgvGSTR27Other.Columns[oCell.ColumnIndex].Name == "colPreGST")
                                                                    dgvGSTR27Other.Rows[iRow].Cells[oCell.ColumnIndex].Value = Utility.StrCDN1PreGSTRegime(sCells[i]);
                                                                else
                                                            ...
                                                            if (j >= 2 && j <= 17)
                                                            {
                                                                if (chkCellValue(sCells[i].Trim(), dgvGSTR27Other.Columns[j].Name))
                                                                {
                                                                    if (dgvGSTR27Other.Columns[j].Name == "colTypeOfNote")
                                                                        dgvGSTR27Other.Rows[iRow].Cells[j].Value = Utility.StrCDN1TypesofNote(sCells[i]);
                                                                    //else if (dgvGSTR27Other.Columns[j].Name == "colReason")
                                                                    //    dgvGSTR27Other.Rows[iRow].Cells[j].Value = Utility.StrCDN1Reasonissuing(sCells[i]);
                                                                    else if (dgvGSTR27Other.Columns[j].Name == "colPreGST")
                                                                        dgvGSTR27Other.Rows[iRow].Cells[j].Value = Utility.StrCDN1PreGSTRegime(sCells[i]);
                                                                    else
                                                ...
                                                if (colNo >= 2 && colNo <= 17)
                                                {
                                                    if (chkCellValue(sCells[i].Trim(), dt.Columns[colNo].ColumnName))
                                                    {
                                                        if (dgvGSTR27Other.Columns[colNo].Name == "colTypeOfNote")
                                                            dt.Rows[dt.Rows.Count - 1][colNo] = Utility.StrCDN1TypesofNote(sCells[i]);
                                                        //else if (dgvGSTR27Other.Columns[colNo].Name == "colReason")
                                                        //    dt.Rows[dt.Rows.Count - 1][colNo] = Utility.StrCDN1Reasonissuing(sCells[i]);
                                                        else if (dgvGSTR27Other.Columns[colNo].Name == "colPreGST")
                                                            dt.Rows[dt.Rows.Count - 1][colNo] = Utility.StrCDN1PreGSTRegime(sCells[i]);
                                                        else
                                            ...
                                            for (int j = colNo; j < dgvGSTR27Other.Columns.Count; j++)
                                            {
                                                ...
                                                else
                                                {
                                                    if (j >= 2 && j <= 17)
                                                    {
                                                        ...
                                                        {
                                                            if (dgvGSTR27Other.Columns[j].Name == "colTypeOfNote")
                                                                dt.Rows[dt.Rows.Count - 1][j] = Utility.StrCDN1TypesofNote(sCells[i]);
                                                            //else if (dgvGSTR27Other.Columns[j].Name == "colReason")
                                                            //    dt.Rows[dt.Rows.Count - 1][j] = Utility.StrCDN1Reasonissuing(sCells[i]);
                                                            else if (dgvGSTR27Other.Columns[j].Name == "colPreGST")
                                                                dt.Rows[dt.Rows.Count - 1][j] = Utility.StrCDN1PreGSTRegime(sCells[i]);
                                                            else
        ...
        public bool IsValidateData()
        {
            ...
            try
            {
                ...
                if (list.Count > 0)
                {
                    ...
                    {
                        this.dgvGSTR27Other.Rows[list[i].Cells["colGSTIN"].RowIndex].Cells["colGSTIN"].Style.BackColor = Color.LightPink;
                    }
                    _cnt++;
                ...
                for (i = 0; i < list.Count; i++)
                {
                    this.dgvGSTR27Other.Rows[list[i].Cells["colGSTIN"].RowIndex].Cells["colGSTIN"].Style.BackColor = Color.LightGreen;
                }
                list = null;
                list = (
                    from x in this.dgvGSTR27Other.Rows.OfType<DataGridViewRow>()
                    where !Utility.CDNTypesofNote(Convert.ToString(x.Cells["colTypeOfNote"].Value))
                    select x).ToList<DataGridViewRow>();
                if (list.Count > 0)
                {
                    for (i = 0; i < list.Count; i++)
                    {
                        this.dgvGSTR27Other.Rows[list[i].Cells["colTypeOfNote"].RowIndex].Cells["colTypeOfNote"].Style.BackColor = Color.LightPink;
                    }
                    _cnt++;
                ...
                for (i = 0; i < list.Count; i++)
                {
                    this.dgvGSTR27Other.Rows[list[i].Cells["colTypeOfNote"].RowIndex].Cells["colTypeOfNote"].Style.BackColor = Color.LightGreen;
                }
                red = "colPreGST";
                list = null;
                list = (
                ...
                if (list.Count > 0)
                {
                    for (i = 0; i < list.Count; i++)
                    {
                        this.dgvGSTR27Other.Rows[list[i].Cells[red].RowIndex].Cells[red].Style.BackColor = Color.LightPink;
                    }
                    _cnt++;
                ...
                for (i = 0; i < list.Count; i++)
                {
                    this.dgvGSTR27Other.Rows[list[i].Cells[red].RowIndex].Cells[red].Style.BackColor = Color.LightGreen;
                }
                ...
                if (list.Count > 0)
                {
                    ...
                    _cnt++;
                    _str = string.Concat(_str, _cnt, ") Please enter Debit Note/ credit note/ Refund voucher No.\n");
                }
                list = (
                    from x in this.dgvGSTR27Other.Rows.OfType<DataGridViewRow>()
                    where Utility.IsInvoiceNumber(Convert.ToString(x.Cells[red].Value))
                ...
                if (list.Count > 0)
                {
                    for (i = 0; i < list.Count; i++)
                    {
                        this.dgvGSTR27Other.Rows[list[i].Cells["colOrginvoiceDate"].RowIndex].Cells["colOrginvoiceDate"].Style.BackColor = Color.LightPink;
                    }
                    _cnt++;
                ...
                for (i = 0; i < list.Count; i++)
                {
                    this.dgvGSTR27Other.Rows[list[i].Cells["colOrginvoiceDate"].RowIndex].Cells["colOrginvoiceDate"].Style.BackColor = Color.LightGreen;
                }
                list = null;
                list = (
                    from x in this.dgvGSTR27Other.Rows.OfType<DataGridViewRow>()
                ...
                if (list.Count > 0)
                {
                    for (i = 0; i < list.Count; i++)
                    {
                        this.dgvGSTR27Other.Rows[list[i].Cells["colTaxable"].RowIndex].Cells["colTaxable"].Style.BackColor = Color.LightPink;
                    }
                    _cnt++;
                ...
                for (i = 0; i < list.Count; i++)
                {
                    if (!(Convert.ToDecimal(this.dgvGSTR27Other.Rows[list[i].Cells["colTaxable"].RowIndex].Cells["colTaxable"].Value) > Convert.ToDecimal(this.dgvGSTR27Other.Rows[list[i].Cells["colOrginvoiceValue"].RowIndex].Cells["colOrginvoiceValue"].Value)))
                    {
                        this.dgvGSTR27Other.Rows[list[i].Cells["colTaxable"].RowIndex].Cells["colTaxable"].Style.BackColor = Color.LightGreen;
                    }
                    else
                    {
                        this.dgvGSTR27Other.Rows[list[i].Cells["colTaxable"].RowIndex].Cells["colTaxable"].Style.BackColor = Color.LightPink;
                ...
                string result = Convert.ToString(CommonHelper.StateName);
                list = this.dgvGSTR27Other.Rows.OfType<DataGridViewRow>().ToList<DataGridViewRow>();
                for (j = 0; j < list.Count; j++)
                {
                    pgst = Convert.ToString(this.dgvGSTR27Other.Rows[list[j].Cells["colPlaceOfSupply"].RowIndex].Cells["colPlaceOfSupply"].Value);
                    if (!(result.ToLower() != pgst.ToLower()))
                    {
                        if (Convert.ToString(this.dgvGSTR27Other.Rows[list[j].Cells["colIGSTAmnt"].RowIndex].Cells["colIGSTAmnt"].Value) != "")
                        {
                            ...
                            {
                                this.dgvGSTR27Other.Rows[list[j].Cells["colIGSTAmnt"].RowIndex].Cells["colIGSTAmnt"].Style.BackColor = Color.LightGreen;
                            }
                            else
                            {
                                _cnt++;
                                _str = string.Concat(_str, _cnt, ") Please enter proper Integrated tax Amount.\n");
                                this.dgvGSTR27Other.Rows[list[j].Cells["colIGSTAmnt"].RowIndex].Cells["colIGSTAmnt"].Style.BackColor = Color.LightPink;
                            }
                        }
                ...
                for (j = 0; j < list.Count; j++)
                {
                    ...
                    if (!(result.ToLower() == pgst.ToLower()))
                    {
                        ...
                        {
                            if (!(Convert.ToDecimal(this.dgvGSTR27Other.Rows[list[j].Cells["colCGSTAmnt"].RowIndex].Cells["colCGSTAmnt"].Value) > new decimal(0)))
                            {
                                this.dgvGSTR27Other.Rows[list[j].Cells["colCGSTAmnt"].RowIndex].Cells["colCGSTAmnt"].Style.BackColor = Color.LightGreen;
                            }
                            else
                            {
                                _cnt++;
                                _str = string.Concat(_str, _cnt, ") Please enter proper Central tax Amount.\n");
                                this.dgvGSTR27Other.Rows[list[j].Cells["colCGSTAmnt"].RowIndex].Cells["colCGSTAmnt"].Style.BackColor = Color.LightPink;
                            }
                        }
                ...
                for (j = 0; j < list.Count; j++)
                {
                    ...
                    if (!(result.ToLower() == pgst.ToLower()))
                    {
                        ...
                        {
                            if (!(Convert.ToDecimal(this.dgvGSTR27Other.Rows[list[j].Cells["colSGSTAmnt"].RowIndex].Cells["colSGSTAmnt"].Value) > new decimal(0)))
                            {
                                this.dgvGSTR27Other.Rows[list[j].Cells["colSGSTAmnt"].RowIndex].Cells["colSGSTAmnt"].Style.BackColor = Color.LightGreen;
                            }
                            else
                            {
                                _cnt++;
                                _str = string.Concat(_str, _cnt, ") Please enter proper State/UT tax Amount.\n");
                                this.dgvGSTR27Other.Rows[list[j].Cells["colSGSTAmnt"].RowIndex].Cells["colSGSTAmnt"].Style.BackColor = Color.LightPink;
                            }
                        }
                ...
                for (j = 0; j < list.Count; j++)
                {
                    ...
                    {
                        this.dgvGSTR27Other.Rows[list[j].Cells["colCessAmnt"].RowIndex].Cells["colCessAmnt"].Style.BackColor = Color.LightGreen;
                    }
                    ...
                    else
                    {
                        ...
                        this.dgvGSTR27Other.Rows[list[j].Cells["colCessAmnt"].RowIndex].Cells["colCessAmnt"].Style.BackColor = Color.LightPink;
                    }
                }
                list = null;
                list = (
                    from x in this.dgvGSTR27Other.Rows.OfType<DataGridViewRow>()
                    where !Utility.IsValidStateName(Convert.ToString(x.Cells["colPlaceOfSupply"].Value))
                    select x).ToList<DataGridViewRow>();
                if (list.Count > 0)
                {
                    for (i = 0; i < list.Count; i++)
                    {
                        this.dgvGSTR27Other.Rows[list[i].Cells["colPlaceOfSupply"].RowIndex].Cells["colPlaceOfSupply"].Style.BackColor = Color.LightPink;
                    }
                    _cnt++;
                ...
                list = (
                    from x in this.dgvGSTR27Other.Rows.OfType<DataGridViewRow>()
                    where Utility.IsNumber(Convert.ToString(x.Cells["colPlaceOfSupply"].Value))
                    select x).ToList<DataGridViewRow>();
                for (i = 0; i < list.Count; i++)
                {
                    this.dgvGSTR27Other.Rows[list[i].Cells["colPlaceOfSupply"].RowIndex].Cells["colPlaceOfSupply"].Style.BackColor = Color.LightGreen;
                }
                DataTable dt1 = (DataTable)this.dgvGSTR27Other.DataSource;
                if (dt1 != null)
                {
                    var result2 = (
                        from row in dt1.AsEnumerable()
                        group row by new { colDbtCrdtNoteNo = row.Field<string>("colDbtCrdtNoteNo"), colGSTIN = row.Field<string>("colGSTIN"), colTypeOfNote = row.Field<string>("colTypeOfNote"), colPreGST = row.Field<string>("colPreGST"), colDbtCrdtNoteDate = row.Field<string>("colDbtCrdtNoteDate"), colOrgInvoiceNo = row.Field<string>("colOrgInvoiceNo"), colOrginvoiceDate = row.Field<string>("colOrginvoiceDate"), colOrginvoiceValue = row.Field<string>("colOrginvoiceValue"), colRate = row.Field<string>("colRate"), colPlaceOfSupply = row.Field<string>("colPlaceOfSupply") } into grp
                        select new { colDbtCrdtNoteNo = grp.Key.colDbtCrdtNoteNo, colGSTIN = grp.Key.colGSTIN, colTypeOfNote = grp.Key.colTypeOfNote, colPreGST = grp.Key.colPreGST, colDbtCrdtNoteDate = grp.Key.colDbtCrdtNoteDate, colOrgInvoiceNo = grp.Key.colOrgInvoiceNo, colOrginvoiceDate = grp.Key.colOrginvoiceDate, colOrginvoiceValue = grp.Key.colOrginvoiceValue, colRate = grp.Key.colRate, colPlaceOfSupply = grp.Key.colPlaceOfSupply }).ToList();
                    if ((result2 == null ? false : result2.Count > 0))
                    {
                        foreach (var variable in result2)
                        {
                            ...
                            list = (
                                from x in this.dgvGSTR27Other.Rows.OfType<DataGridViewRow>()
                                where (!(Convert.ToString(x.Cells["colDbtCrdtNoteNo"].Value) == Convert.ToString(variable.colDbtCrdtNoteNo)) || !(Convert.ToString(x.Cells["colGSTIN"].Value) == Convert.ToString(variable.colGSTIN)) ? false : Convert.ToString(x.Cells["colTypeOfNote"].Value) != Convert.ToString(variable.colTypeOfNote))
                                select x into p
                            ...
                            if ((list == null ? false : list.Count > 0))
                            {
                                ...
                                _cnt++;
                                _str = string.Concat(_str, _cnt, ") Same GSTIN no and invoice no for different Type Of Note is not possible.\n");
                            }
                            list = null;
                            list = (
                                from x in this.dgvGSTR27Other.Rows.OfType<DataGridViewRow>()
                                where (!(Convert.ToString(x.Cells["colDbtCrdtNoteNo"].Value) == Convert.ToString(variable.colDbtCrdtNoteNo)) || !(Convert.ToString(x.Cells["colGSTIN"].Value) == Convert.ToString(variable.colGSTIN)) ? false : Convert.ToString(x.Cells["colPreGST"].Value) != Convert.ToString(variable.colPreGST))
                                select x into p
                                select p).ToList<DataGridViewRow>();
                            if ((list == null ? false : list.Count > 0))
                            {
                                for (i = 0; i < list.Count; i++)
                                {
                                    this.dgvGSTR27Other.Rows[list[i].Cells["colPreGST"].RowIndex].Cells["colPreGST"].Style.BackColor = Color.LightPink;
                                }
                                _cnt++;
                                _str = string.Concat(_str, _cnt, ") Same GSTIN no and invoice no for different Pre GST is not possible.\n");
                            }
                            list = null;
                            list = (
                                from x in this.dgvGSTR27Other.Rows.OfType<DataGridViewRow>()
                                where (!(Convert.ToString(x.Cells["colDbtCrdtNoteNo"].Value) == Convert.ToString(variable.colDbtCrdtNoteNo)) || !(Convert.ToString(x.Cells["colGSTIN"].Value) == Convert.ToString(variable.colGSTIN)) ? false : Convert.ToString(x.Cells["colDbtCrdtNoteDate"].Value) != Convert.ToString(variable.colDbtCrdtNoteDate))
                                select x into p
                                select p).ToList<DataGridViewRow>();
                            if ((list == null ? false : list.Count > 0))
                            {
                                for (i = 0; i < list.Count; i++)
                                {
                                    this.dgvGSTR27Other.Rows[list[i].Cells["colDbtCrdtNoteDate"].RowIndex].Cells["colDbtCrdtNoteDate"].Style.BackColor = Color.LightPink;
                                }
                                _cnt++;
                                _str = string.Concat(_str, _cnt, ") Same GSTIN no and invoice no for different Debit Note/ credit note/ Refund voucher Date is not possible.\n");
                            }
                            list = null;
                            list = (
                                from x in this.dgvGSTR27Other.Rows.OfType<DataGridViewRow>()
                                where (!(Convert.ToString(x.Cells["colDbtCrdtNoteNo"].Value) == Convert.ToString(variable.colDbtCrdtNoteNo)) || !(Convert.ToString(x.Cells["colGSTIN"].Value) == Convert.ToString(variable.colGSTIN)) ? false : Convert.ToString(x.Cells["colOrgInvoiceNo"].Value) != Convert.ToString(variable.colOrgInvoiceNo))
                                select x into p
                                select p).ToList<DataGridViewRow>();
                            if ((list == null ? false : list.Count > 0))
                            {
                                for (i = 0; i < list.Count; i++)
                                {
                                    this.dgvGSTR27Other.Rows[list[i].Cells["colOrgInvoiceNo"].RowIndex].Cells["colOrgInvoiceNo"].Style.BackColor = Color.LightPink;
                                }
                                _cnt++;
                                _str = string.Concat(_str, _cnt, ") Same GSTIN no and invoice no for different Org Invoice Number is not possible.\n");
                            }
                            list = null;
                            list = (
                                from x in this.dgvGSTR27Other.Rows.OfType<DataGridViewRow>()
                                where (!(Convert.ToString(x.Cells["colDbtCrdtNoteNo"].Value) == Convert.ToString(variable.colDbtCrdtNoteNo)) || !(Convert.ToString(x.Cells["colGSTIN"].Value) == Convert.ToString(variable.colGSTIN)) ? false : Convert.ToString(x.Cells["colOrginvoiceDate"].Value) != Convert.ToString(variable.colOrginvoiceDate))
                                select x into p
                                select p).ToList<DataGridViewRow>();
                            if ((list == null ? false : list.Count > 0))
                            {
                                ...
                                _cnt++;
                                _str = string.Concat(_str, _cnt, ") Same GSTIN no and invoice no for different Org Invoice Date is not possible.\n");
                            }
                            list = null;
                            list = (
                                from x in this.dgvGSTR27Other.Rows.OfType<DataGridViewRow>()
                                where (!(Convert.ToString(x.Cells["colDbtCrdtNoteNo"].Value) == Convert.ToString(variable.colDbtCrdtNoteNo)) || !(Convert.ToString(x.Cells["colGSTIN"].Value) == Convert.ToString(variable.colGSTIN)) ? false : Convert.ToString(x.Cells["colOrginvoiceValue"].Value) != Convert.ToString(variable.colOrginvoiceValue))
                                select x into p
                                select p).ToList<DataGridViewRow>();
                            if ((list == null ? false : list.Count > 0))
                            {
                                for (i = 0; i < list.Count; i++)
                                {
                                    this.dgvGSTR27Other.Rows[list[i].Cells["colOrginvoiceValue"].RowIndex].Cells["colOrginvoiceValue"].Style.BackColor = Color.LightPink;
                                }
                                _cnt++;
                                _str = string.Concat(_str, _cnt, ") Same GSTIN no and invoice no for different Org Invoice Value is not possible.\n");
                            }
                            list = null;
                            list = (
                                from x in this.dgvGSTR27Other.Rows.OfType<DataGridViewRow>()
                                where (!(Convert.ToString(x.Cells["colGSTIN"].Value) == Convert.ToString(variable.colGSTIN)) || !(Convert.ToString(x.Cells["colRate"].Value) == Convert.ToString(variable.colRate)) ? false : Convert.ToString(x.Cells["colDbtCrdtNoteNo"].Value) == Convert.ToString(variable.colDbtCrdtNoteNo))
                                select x into p
                                select p).ToList<DataGridViewRow>();
                            if ((list == null ? true : list.Count <= 1))
                            {
                                for (i = 0; i < list.Count; i++)
                                {
                                    this.dgvGSTR27Other.Rows[list[i].Cells["colRate"].RowIndex].Cells["colRate"].Style.BackColor = Color.LightGreen;
                                }
                            }
                            else
                            {
                                for (i = 0; i < list.Count; i++)
                                {
                                    this.dgvGSTR27Other.Rows[list[i].Cells["colRate"].RowIndex].Cells["colRate"].Style.BackColor = Color.LightPink;
                                }
                                _cnt++;
                ...
                if (!(_str != ""))
                {
                    if (this.objGSTR7A.InsertValidationFlg("GSTR1", "CDN", "true", CommonHelper.SelectedMonth) != 1)
                    {
                ...
                else
                {
                    ...
                    if (this.objGSTR7A.InsertValidationFlg("GSTR1", "CDN", "false", CommonHelper.SelectedMonth) != 1)
                    {
                        MessageBox.Show("System error.\nPlease try after sometime! SPQValidation Error", "System Error", MessageBoxButtons.OK, MessageBoxIcon.Hand);
                    }
        ...
        public bool IsValidateData_old()
        {
            try
            {
                ...
                list = dgvGSTR27Other.Rows
                       .OfType<DataGridViewRow>()
                       .Where(x => true != Utility.CDNTypesofNote(Convert.ToString(x.Cells["colTypeOfNote"].Value)))
                       .Select(x => x)
                       .ToList();
                if (list.Count > 0)
                {
                ...
                #region same Invoice number for Same Type Of Note is required
                /*
                DataTable dt1 = (DataTable)dgvGSTR27Other.DataSource;

                if (dt1 != null)
                {
                    var result2 = (from row in dt1.AsEnumerable()
                                   group row by new { colDbtCrdtNoteNo = row.Field<string>("colDbtCrdtNoteNo"), colGSTIN = row.Field<string>("colGSTIN"), colTypeOfNote = row.Field<string>("colTypeOfNote") } into grp
                                   select new
                                   {
                                       colDbtCrdtNoteNo = grp.Key.colDbtCrdtNoteNo,
                                       colGSTIN = grp.Key.colGSTIN,
                                       colTypeOfNote = grp.Key.colTypeOfNote,
                                   }).ToList();
                    ...
                    if (result2 != null && result2.Count > 0)
                    {
                        ...
                        {
                            #region Same Invoice no Same Type of Note
                            list = dgvGSTR27Other.Rows
                                    .OfType<DataGridViewRow>()
                                    .Where(x => Convert.ToString(x.Cells["colDbtCrdtNoteNo"].Value) == Convert.ToString(item.colDbtCrdtNoteNo) && Convert.ToString(x.Cells["colGSTIN"].Value) == Convert.ToString(item.colGSTIN) && Convert.ToString(x.Cells["colTypeOfNote"].Value) != Convert.ToString(item.colTypeOfNote))
                                    .Select(p => p)
                                    .ToList();
                            ...
                            if (list != null && list.Count > 0)
                            {
                                ...
                                _cnt += 1;
                                _str += _cnt + ") Same GSTIN no and invoice no for different Type Of Note is not possible.\n";
                            }
                            #endregion
                        }
                    }
                ...
                #region same Invoice number for Same Pre GST is required
                /*
                DataTable dt3 = (DataTable)dgvGSTR27Other.DataSource;
                if (dt3 != null)
                {
                    var result3 = (from row in dt3.AsEnumerable()
                                   group row by new { colDbtCrdtNoteNo = row.Field<string>("colDbtCrdtNoteNo"), colGSTIN = row.Field<string>("colGSTIN"), colPreGST = row.Field<string>("colPreGST") } into grp
                                   select new
                                   {
                                       colDbtCrdtNoteNo = grp.Key.colDbtCrdtNoteNo,
                                       colGSTIN = grp.Key.colGSTIN,
                                       colPreGST = grp.Key.colPreGST,
                                   }).ToList();
                    ...
                    if (result3 != null && result3.Count > 0)
                    {
                        ...
                        {
                            #region Same Invoice no Same Pre GST
                            list = dgvGSTR27Other.Rows
                                    .OfType<DataGridViewRow>()
                                    .Where(x => Convert.ToString(x.Cells["colDbtCrdtNoteNo"].Value) == Convert.ToString(item.colDbtCrdtNoteNo) && Convert.ToString(x.Cells["colGSTIN"].Value) == Convert.ToString(item.colGSTIN) && Convert.ToString(x.Cells["colPreGST"].Value) != Convert.ToString(item.colPreGST))
                                    .Select(p => p)
                                    .ToList();
                            ...
                            if (list != null && list.Count > 0)
                            {
                                for (int i = 0; i < list.Count; i++)
                                {
                                    dgvGSTR27Other.Rows[list[i].Cells["colPreGST"].RowIndex].Cells["colPreGST"].Style.BackColor = Color.Red;
                                }
                                _cnt += 1;
                                _str += _cnt + ") Same GSTIN no and invoice no for different Pre GST is not possible.\n";
                            }
                            #endregion
                        }
                    }
                ...
                if (list.Count > 0)
                {
                    ...
                    _cnt += 1;
                    _str += _cnt + ") Please enter Debit Note/ credit note/ Refund voucher No.\n";
                }
                list = dgvGSTR27Other.Rows
                       .OfType<DataGridViewRow>()
                       .Where(x => true == Utility.IsInvoiceNumber(Convert.ToString(x.Cells[sj].Value)))
                ...
                #region same Invoice number for Same Debit Note/ credit note/ Refund voucher Date is required
                /*
                DataTable dt4 = (DataTable)dgvGSTR27Other.DataSource;
                if (dt4 != null)
                {
                    var result4 = (from row in dt4.AsEnumerable()
                                   group row by new { colDbtCrdtNoteNo = row.Field<string>("colDbtCrdtNoteNo"), colGSTIN = row.Field<string>("colGSTIN"), colDbtCrdtNoteDate = row.Field<string>("colDbtCrdtNoteDate") } into grp
                                   select new
                                   {
                                       colDbtCrdtNoteNo = grp.Key.colDbtCrdtNoteNo,
                                       colGSTIN = grp.Key.colGSTIN,
                                       colDbtCrdtNoteDate = grp.Key.colDbtCrdtNoteDate,
                                   }).ToList();
                    ...
                    if (result4 != null && result4.Count > 0)
                    {
                        ...
                        {
                            #region Same Invoice no Same Debit Note/ credit note/ Refund voucher Date
                            list = dgvGSTR27Other.Rows
                                    .OfType<DataGridViewRow>()
                                    .Where(x => Convert.ToString(x.Cells["colDbtCrdtNoteNo"].Value) == Convert.ToString(item.colDbtCrdtNoteNo) && Convert.ToString(x.Cells["colGSTIN"].Value) == Convert.ToString(item.colGSTIN) && Convert.ToString(x.Cells["colDbtCrdtNoteDate"].Value) != Convert.ToString(item.colDbtCrdtNoteDate))
                                    .Select(p => p)
                                    .ToList();
                            ...
                            if (list != null && list.Count > 0)
                            {
                                for (int i = 0; i < list.Count; i++)
                                {
                                    dgvGSTR27Other.Rows[list[i].Cells["colDbtCrdtNoteDate"].RowIndex].Cells["colDbtCrdtNoteDate"].Style.BackColor = Color.Red;
                                }
                                _cnt += 1;
                                _str += _cnt + ") Same GSTIN no and invoice no for different Debit Note/ credit note/ Refund voucher Date is not possible.\n";
                            }
                            #endregion
                        }
                    }
                ...
                #region same Invoice number for Same Org Invoice Number is required
                /*
                DataTable dt5 = (DataTable)dgvGSTR27Other.DataSource;
                if (dt5 != null)
                {
                    var result5 = (from row in dt5.AsEnumerable()
                                   group row by new { colDbtCrdtNoteNo = row.Field<string>("colDbtCrdtNoteNo"), colGSTIN = row.Field<string>("colGSTIN"), colOrgInvoiceNo = row.Field<string>("colOrgInvoiceNo") } into grp
                                   select new
                                   {
                                       colDbtCrdtNoteNo = grp.Key.colDbtCrdtNoteNo,
                                       colGSTIN = grp.Key.colGSTIN,
                                       colOrgInvoiceNo = grp.Key.colOrgInvoiceNo,
                                   }).ToList();
                    ...
                    if (result5 != null && result5.Count > 0)
                    {
                        ...
                        {
                            #region Same Invoice no Same Org invoice Number
                            list = dgvGSTR27Other.Rows
                                    .OfType<DataGridViewRow>()
                                    .Where(x => Convert.ToString(x.Cells["colDbtCrdtNoteNo"].Value) == Convert.ToString(item.colDbtCrdtNoteNo) && Convert.ToString(x.Cells["colGSTIN"].Value) == Convert.ToString(item.colGSTIN) && Convert.ToString(x.Cells["colOrgInvoiceNo"].Value) != Convert.ToString(item.colOrgInvoiceNo))
                                    .Select(p => p)
                                    .ToList();
                            ...
                            if (list != null && list.Count > 0)
                            {
                                ...
                                _cnt += 1;
                                _str += _cnt + ") Same GSTIN no and invoice no for different Org Invoice Number is not possible.\n";
                            }
                            #endregion
                        }
                    }
                ...
                #region same Invoice number for Same Org Invoice Date is required
                /*
                DataTable dt6 = (DataTable)dgvGSTR27Other.DataSource;
                if (dt6 != null)
                {
                    var result6 = (from row in dt6.AsEnumerable()
                                   group row by new { colDbtCrdtNoteNo = row.Field<string>("colDbtCrdtNoteNo"), colGSTIN = row.Field<string>("colGSTIN"), colOrginvoiceDate = row.Field<string>("colOrginvoiceDate") } into grp
                                   select new
                                   {
                                       colDbtCrdtNoteNo = grp.Key.colDbtCrdtNoteNo,
                                       colGSTIN = grp.Key.colGSTIN,
                                       colOrginvoiceDate = grp.Key.colOrginvoiceDate,
                                   }).ToList();
                    ...
                    if (result6 != null && result6.Count > 0)
                    {
                        ...
                        {
                            #region Same Invoice no Same Org invoice Date
                            list = dgvGSTR27Other.Rows
                                    .OfType<DataGridViewRow>()
                                    .Where(x => Convert.ToString(x.Cells["colDbtCrdtNoteNo"].Value) == Convert.ToString(item.colDbtCrdtNoteNo) && Convert.ToString(x.Cells["colGSTIN"].Value) == Convert.ToString(item.colGSTIN) && Convert.ToString(x.Cells["colOrginvoiceDate"].Value) != Convert.ToString(item.colOrginvoiceDate))
                                    .Select(p => p)
                                    .ToList();
                            ...
                            if (list != null && list.Count > 0)
                            {
                                ...
                                _cnt += 1;
                                _str += _cnt + ") Same GSTIN no and invoice no for different Org Invoice Date is not possible.\n";
                            }
                            #endregion
                        }
                    }
                ...
                #region same Invoice number for Same Org Invoice Value is required
                /*
                DataTable dt7 = (DataTable)dgvGSTR27Other.DataSource;
                if (dt7 != null)
                {
                    var result7 = (from row in dt7.AsEnumerable()
                                   group row by new { colDbtCrdtNoteNo = row.Field<string>("colDbtCrdtNoteNo"), colGSTIN = row.Field<string>("colGSTIN"), colOrginvoiceValue = row.Field<string>("colOrginvoiceValue") } into grp
                                   select new
                                   {
                                       colDbtCrdtNoteNo = grp.Key.colDbtCrdtNoteNo,
                                       colGSTIN = grp.Key.colGSTIN,
                    ...
                    if (result7 != null && result7.Count > 0)
                    {
                        ...
                        {
                            #region Same Invoice no Same Org invoice Value
                            list = dgvGSTR27Other.Rows
                                    .OfType<DataGridViewRow>()
                                    .Where(x => Convert.ToString(x.Cells["colDbtCrdtNoteNo"].Value) == Convert.ToString(item.colDbtCrdtNoteNo) && Convert.ToString(x.Cells["colGSTIN"].Value) == Convert.ToString(item.colGSTIN) && Convert.ToString(x.Cells["colOrginvoiceValue"].Value) != Convert.ToString(item.colOrginvoiceValue))
                                    .Select(p => p)
                                    .ToList();
                            ...
                            if (list != null && list.Count > 0)
                            {
                                for (int i = 0; i < list.Count; i++)
                                {
                                    dgvGSTR27Other.Rows[list[i].Cells["colOrginvoiceValue"].RowIndex].Cells["colOrginvoiceValue"].Style.BackColor = Color.Red;
                                }
                                _cnt += 1;
                                _str += _cnt + ") Same GSTIN no and invoice no for different Org Invoice Value is not possible.\n";
                            }
                            #endregion
                        }
                    }
                ...
                /*
                DataTable dt8 = (DataTable)dgvGSTR27Other.DataSource;
                if (dt8 != null)
                {
                    var result8 = (from row in dt8.AsEnumerable()
                                   group row by new { colDbtCrdtNoteNo = row.Field<string>("colDbtCrdtNoteNo"), colGSTIN = row.Field<string>("colGSTIN"), colRate = row.Field<string>("colRate") } into grp
                                   select new
                                   {
                                       colGSTIN = grp.Key.colGSTIN,
                                       colDbtCrdtNoteNo = grp.Key.colDbtCrdtNoteNo,
                    ...
                    if (result8 != null && result8.Count > 0)
                    {
                        foreach (var item in result8)
                        {
                            ...
                            list = dgvGSTR27Other.Rows
                                    .OfType<DataGridViewRow>()
                                    .Where(x => Convert.ToString(x.Cells["colGSTIN"].Value) == Convert.ToString(item.colGSTIN) && Convert.ToString(x.Cells["colRate"].Value) == Convert.ToString(item.colRate) && Convert.ToString(x.Cells["colDbtCrdtNoteNo"].Value) == Convert.ToString(item.colDbtCrdtNoteNo))
                                    .Select(p => p)
                                    .ToList();
                            ...
                            if (list != null && list.Count > 1)
                            {
                                for (int i = 0; i < list.Count; i++)
                                {
                                    dgvGSTR27Other.Rows[list[i].Cells["colRate"].RowIndex].Cells["colRate"].Style.BackColor = Color.Red;
                                }
                                _cnt += 1;
                            ...
                            else
                            {
                                for (int i = 0; i < list.Count; i++)
                                {
                                    dgvGSTR27Other.Rows[list[i].Cells["colRate"].RowIndex].Cells["colRate"].Style.BackColor = Color.White;
                                }
                            }
                            #endregion
                        }
                ...
                for (int i = 0; i < list.Count; i++)
                {
                    ...
                    if (Convert.ToDecimal(dgvGSTR27Other.Rows[list[i].Cells["colTaxable"].RowIndex].Cells["colTaxable"].Value) > Convert.ToDecimal(dgvGSTR27Other.Rows[list[i].Cells["colOrginvoiceValue"].RowIndex].Cells["colOrginvoiceValue"].Value))
                    {
                        dgvGSTR27Other.Rows[list[i].Cells["colTaxable"].RowIndex].Cells["colTaxable"].Style.BackColor = Color.Red;
                        _cnt += 1;
                    ...
                    for (int i = 0; i < list.Count; i++)
                    {
                        ...
                        if (Convert.ToDecimal(dgvGSTR27Other.Rows[list[i].Cells["colCGSTAmnt"].RowIndex].Cells["colCGSTAmnt"].Value) == ComValue && Convert.ToDecimal(dgvGSTR27Other.Rows[list[i].Cells["colSGSTAmnt"].RowIndex].Cells["colSGSTAmnt"].Value) == ComValue)
                        {
                            ...
                            if (dgvGSTR27Other.Rows[list[i].Cells["colSGSTAmnt"].RowIndex].Cells["colSGSTAmnt"].Style.BackColor != Color.Red)
                                dgvGSTR27Other.Rows[list[i].Cells["colSGSTAmnt"].RowIndex].Cells["colCGSTAmnt"].Style.BackColor = Color.White;
                        }
                        else
                        {
                ...
                */
                ...
                {
                    CommonHelper.StatusText = "Draft";
                    int _Result = objGSTR7A.InsertValidationFlg("GSTR1", "CDN", "false", CommonHelper.SelectedMonth);
                    if (_Result != 1)
                ...
                {                    
                    int _Result = objGSTR7A.InsertValidationFlg("GSTR1", "CDN", "true", CommonHelper.SelectedMonth);
                    if (_Result != 1)
                        MessageBox.Show("System error.\nPlease try after sometime! SPQValidation Error", "System Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private Boolean chkCellValue(string cellValue, string cNo)
        {
            try
            {
                if (cellValue.Trim() != "")// NOT EQUEL BLANK
                {
                    ...
                    {
                        if (Utility.CDN1TypesofNote(cellValue))
                            return true;
                        else
                            return false;
                    }
                    ...
                    {
                        if (Utility.CDN1PreGSTRegime(cellValue))
                            return true;
                        else
                            return false;
                    }
                    ...
                    //{
                    //    if (Utility.CDN1Reasonissuing(cellValue))
                    //        return true;
                    //    else
                    //        return false;
                    //}
        ...
        private void dgvGSTR27Other_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (e.RowIndex >= 0)
                {
                    ...
                    {
                        if (!chkCellValue(Convert.ToString(dgvGSTR27Other.Rows[e.RowIndex].Cells[cNo].Value).Trim(), cNo))
                            dgvGSTR27Other.Rows[e.RowIndex].Cells[cNo].Value = Utility.StrCDN1TypesofNote(Convert.ToString(dgvGSTR27Other.Rows[e.RowIndex].Cells[cNo].Value));
                    ...
                    //{
                    //    if (!chkCellValue(Convert.ToString(dgvGSTR27Other.Rows[e.RowIndex].Cells[cNo].Value).Trim(), cNo))
                    //        dgvGSTR27Other.Rows[e.RowIndex].Cells[cNo].Value = Utility.StrCDN1Reasonissuing(Convert.ToString(dgvGSTR27Other.Rows[e.RowIndex].Cells[cNo].Value));
                    //}
                    else if (cNo == "colPreGST")
                    {
                        if (!chkCellValue(Convert.ToString(dgvGSTR27Other.Rows[e.RowIndex].Cells[cNo].Value).Trim(), cNo))
                            dgvGSTR27Other.Rows[e.RowIndex].Cells[cNo].Value = Utility.StrCDN1PreGSTRegime(Convert.ToString(dgvGSTR27Other.Rows[e.RowIndex].Cells[cNo].Value));
                    }
                    ...
                    {
                        if (!chkCellValue(Convert.ToString(dgvGSTR27Other.Rows[e.RowIndex].Cells[cNo].Value).Trim(), cNo))
                            dgvGSTR27Other.Rows[e.RowIndex].Cells[cNo].Value = "No";
                    }
                }
            }
            catch (Exception ex)
        ...
        public void Save()
        {
            try
            {
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    _Result = objGSTR7A.GSTR18OBulkEntry(dt, Convert.ToString(CommonHelper.StatusText));
                    ...
                    if (_Result == 1)
                    {
                        ...
                        _Result = objGSTR7A.GSTR18OBulkEntry(dt, "Total");
                ...
                try
                {
                    ...
                    if (dtexcel != null && dtexcel.Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < dtexcel.Rows.Count; i++)
                        {
                            ...
                            if (Utility.CDN1TypesofNote(Convert.ToString(dtexcel.Rows[i]["colTypeOfNote"]).Trim()))
                                dtexcel.Rows[i]["colTypeOfNote"] = Utility.StrCDN1TypesofNote(Convert.ToString(dtexcel.Rows[i]["colTypeOfNote"]).Trim());
                            else
                                dtexcel.Rows[i]["colTypeOfNote"] = "";

                            //if (Utility.CDN1Reasonissuing(Convert.ToString(dtexcel.Rows[i]["colReason"]).Trim()))
                            //    dtexcel.Rows[i]["colReason"] = Utility.StrCDN1Reasonissuing(Convert.ToString(dtexcel.Rows[i]["colReason"]).Trim());
                            //else
                            //    dtexcel.Rows[i]["colReason"] = "";

                            if (Utility.CDN1PreGSTRegime(Convert.ToString(dtexcel.Rows[i]["colPreGST"]).Trim()))
                                dtexcel.Rows[i]["colPreGST"] = Utility.StrCDN1PreGSTRegime(Convert.ToString(dtexcel.Rows[i]["colPreGST"]).Trim());
                            else
                    ...
                    for (int k = 0; k < dgvGSTR27Other.Rows.Count; k++)
                    {
                        ...
                        for (int j = 0; j < dgvGSTR27Other.ColumnCount; j++)
                        {
                            if (dgvGSTR27Other.Rows[k].Cells[j].Style.BackColor == Color.Red)
                            {
                                ...
                                if (dgvGSTR27Other.Columns[j].Name == "colGSTIN")
                                {
                                    if (dgvGSTR27Other.Rows[k].Cells[j].Value == "")
                                        str_error += cnt + ") " + " Please enter " + dgvGSTR27Other.Columns[j].HeaderText + ".\n";
                                    else
                                        str_error += cnt + ") Enter 15 Digit GSTR Number OR Enter in proper format. \n";
                                }
                                else if (dgvGSTR27Other.Columns[j].Name == "colTypeOfNote")
                                {
                                    if (dgvGSTR27Other.Rows[k].Cells[j].Value == "")
                                        str_error += cnt + ") " + " Please select proper " + dgvGSTR27Other.Columns[j].HeaderText + ".\n";
                                    else
                                        str_error += cnt + ") Same GSTIN no and " + dgvGSTR27Other.Columns["colDbtCrdtNoteNo"].HeaderText + " for different " + dgvGSTR27Other.Columns[j].HeaderText + " is not possible.\n";
                                }
                                else if (dgvGSTR27Other.Columns[j].Name == "colPreGST")
                                {
                                    if (dgvGSTR27Other.Rows[k].Cells[j].Value == "")
                                ...
                                else if (dgvGSTR27Other.Columns[j].Name == "colInvoiceNo")
                                {
                                    if (dgvGSTR27Other.Rows[k].Cells[j].Value == "")
                                        str_error += cnt + ") " + " Please enter " + dgvGSTR27Other.Columns[j].HeaderText + ".\n";
                                    else
                                ...
                                else if (dgvGSTR27Other.Columns[j].Name == "colRate")
                                {
                                    if (dgvGSTR27Other.Rows[k].Cells[j].Value.ToString() == "")
                                        ...
                                        str_error += cnt + ") " + " Please enter proper " + dgvGSTR27Other.Columns[j].HeaderText + "(Ex : (0),(2.5),(3),(5),(12),(18),(28)) And Same rate can not be possible more than one time on same " + dgvGSTR27Other.Columns["colDbtCrdtNoteNo"].HeaderText + ". \n";
                                }

                                else if (dgvGSTR27Other.Columns[j].Name == "colDbtCrdtNoteDate")
                                {
                                    if (dgvGSTR27Other.Rows[k].Cells[j].Value == "")
                                        str_error += cnt + ") " + " Please enter proper " + dgvGSTR27Other.Columns[j].HeaderText + ".\n";
                                    else
                                        str_error += cnt + ") " + dgvGSTR27Other.Columns[j].HeaderText + " allows only selected month date OR Same GSTIN no and invoice no for different Debit Note/ credit note/ Refund voucher Date is not possible.\n";
                                }
                                else if (dgvGSTR27Other.Columns[j].Name == "colOrgInvoiceNo")
                                {
                                    if (dgvGSTR27Other.Rows[k].Cells[j].Value == "")
                                        str_error += cnt + ") " + " Please enter proper " + dgvGSTR27Other.Columns[j].HeaderText + ".\n";
                                    else
                                        str_error += cnt + ") " + dgvGSTR27Other.Columns[j].HeaderText + " is not valid OR Same GSTIN no and invoice no for different " + dgvGSTR27Other.Columns[j].HeaderText + " is not possible. \n";
                                }
                                else if (dgvGSTR27Other.Columns[j].Name == "colOrginvoiceDate")
                                {
                                    if (dgvGSTR27Other.Rows[k].Cells[j].Value == "")
                                        ...
                                        str_error += cnt + ") Please enter date in dd-MM-yyyy format. For Credit note if Pre GST is Yes then " + dgvGSTR27Other.Columns[j].HeaderText + " must be less than credit/debit note month date and if Pre GST is No then " + dgvGSTR27Other.Columns[j].HeaderText + " must be selected month or selected quarter date and less than or equal to credit/debit note date OR Same GSTIN no and invoice no for different " + dgvGSTR27Other.Columns[j].HeaderText + " is not possible. \n";
                                }
                                else if (dgvGSTR27Other.Columns[j].Name == "colOrginvoiceValue")
                                {
                                    if (dgvGSTR27Other.Rows[k].Cells[j].Value == "")
                                        str_error += cnt + ") " + " Please enter proper " + dgvGSTR27Other.Columns[j].HeaderText + ".\n";
                                    else
                                        str_error += cnt + ") " + dgvGSTR27Other.Columns[j].HeaderText + " is allows 15 digit number value And Same GSTIN no and invoice no for different " + dgvGSTR27Other.Columns[j].HeaderText + " is not possible. \n";
                                }
                                else if (dgvGSTR27Other.Columns[j].Name == "colPlaceOfSupply")
                                {
                                    if (dgvGSTR27Other.Rows[k].Cells[j].Value == "")
                                        str_error += cnt + ") " + " Please select proper " + dgvGSTR27Other.Columns[j].HeaderText + ".\n";
                                    else
                                        str_error += cnt + ") Different " + dgvGSTR27Other.Columns[j].HeaderText + " can not be possible for same invoice no. \n";
                                }
        ...
        private void txtSearch_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                ((DataTable)dgvGSTR27Other.DataSource).DefaultView.RowFilter = string.Format("colSequence like '%{0}%' or colGSTIN like '%{0}%' or colParty like '%{0}%' or colTypeOfNote like '%{0}%' or colPreGST like '%{0}%' or colDbtCrdtNoteNo like '%{0}%' or colDbtCrdtNoteDate like '%{0}%' or colOrgInvoiceNo like '%{0}%' or colOrginvoiceDate like '%{0}%' or colRate like '%{0}%' or colTaxable like '%{0}%' or colIGSTAmnt like '%{0}%' or colCGSTAmnt like '%{0}%' or colSGSTAmnt like '%{0}%' or colCessAmnt like '%{0}%' or colPlaceOfSupply like '%{0}%'", txtSearch.Text.Trim().Replace("'", "''"));
            }
            catch (Exception ex)
            {
                MessageBox.Show("Error : " + ex.Message, "Technical Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
