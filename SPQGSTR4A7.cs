...
{
    public partial class SPQGSTR4A7 : Form
    {
        ...
        private void GetData()
        {
            try
            {
                ...
                string Query = "Select * from GSTR4AFormPartB7 where Fld_Month='" + CommonHelper.SelectedMonth + "' AND Fld_FinancialYear = '" + CommonHelper.ReturnYear + "' and Fld_FileStatus != 'Total'";
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    foreach (DataGridViewColumn col in dgvGSTR4A7.Columns)
                    {
        ...
        public void GetTotal(int[] colNo)
        {
            try
            {
                if (dgvGSTR4A7.Rows.Count > 1)
                {
                    // IF MAIN GRID HAVING RECORDS

                    if (dgvGSTR4A7Total.Rows.Count == 0)
                    {
                        ...
                        foreach (DataGridViewColumn col in dgvGSTR4A7Total.Columns)
                        {
                        ...
                        dr["colTInvoiceDocNo"] = dgvGSTR4A7.Rows.Cast<DataGridViewRow>().Where(x => Convert.ToString(x.Cells[3].Value).Trim() != "").GroupBy(x => x.Cells[3].Value).Select(x => x.First()).Distinct().Count();
                        dr["colTInvoiceDocValue"] = dgvGSTR4A7.Rows.Cast<DataGridViewRow>().Where(x => x.Cells[5].Value != null).Sum(x => x.Cells[5].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells[5].Value)).ToString();
                        dr["colTValueOnTDS"] = dgvGSTR4A7.Rows.Cast<DataGridViewRow>().Where(x => x.Cells[7].Value != null).Sum(x => x.Cells[7].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells[7].Value)).ToString();
                        dr["colTTDSIGSTAmt"] = dgvGSTR4A7.Rows.Cast<DataGridViewRow>().Where(x => x.Cells[9].Value != null).Sum(x => x.Cells[9].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells[9].Value)).ToString();
                        dr["colTTDSCGSTAmt"] = dgvGSTR4A7.Rows.Cast<DataGridViewRow>().Where(x => x.Cells[11].Value != null).Sum(x => x.Cells[11].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells[11].Value)).ToString();
                        dr["colTTDSSGSTAmt"] = dgvGSTR4A7.Rows.Cast<DataGridViewRow>().Where(x => x.Cells[13].Value != null).Sum(x => x.Cells[13].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells[13].Value)).ToString();
                        ...
                        dgvGSTR4A7Total.DataSource = dtTotal;

                        #endregion
                    }
                    else if (dgvGSTR4A7Total.Rows.Count == 1)
                    {
                        ...
                        {
                            if (item == 3)
                                dgvGSTR4A7Total.Rows[0].Cells[3].Value = dgvGSTR4A7.Rows.Cast<DataGridViewRow>().Where(x => Convert.ToString(x.Cells[3].Value).Trim() != "").GroupBy(x => x.Cells[3].Value).Select(x => x.First()).Distinct().Count();
                            else if (item == 5)
                                dgvGSTR4A7Total.Rows[0].Cells[5].Value = dgvGSTR4A7.Rows.Cast<DataGridViewRow>().Where(x => x.Cells[5].Value != null).Sum(x => x.Cells[5].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells[5].Value)).ToString();
                            else if (item == 7)
                                dgvGSTR4A7Total.Rows[0].Cells[7].Value = dgvGSTR4A7.Rows.Cast<DataGridViewRow>().Where(x => x.Cells[7].Value != null).Sum(x => x.Cells[7].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells[7].Value)).ToString();
                            else if (item == 9)
                                dgvGSTR4A7Total.Rows[0].Cells[9].Value = dgvGSTR4A7.Rows.Cast<DataGridViewRow>().Where(x => x.Cells[9].Value != null).Sum(x => x.Cells[9].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells[9].Value)).ToString();
                            else if (item == 11)
                                dgvGSTR4A7Total.Rows[0].Cells[11].Value = dgvGSTR4A7.Rows.Cast<DataGridViewRow>().Where(x => x.Cells[11].Value != null).Sum(x => x.Cells[11].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells[11].Value)).ToString();
                            else if (item == 13)
                                dgvGSTR4A7Total.Rows[0].Cells[13].Value = dgvGSTR4A7.Rows.Cast<DataGridViewRow>().Where(x => x.Cells[13].Value != null).Sum(x => x.Cells[13].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells[13].Value)).ToString();
                        }
                        #endregion
                    }

                    // SET GRID ROW HEIGHT AND ASSIGN TOTAL HEADER
                    dgvGSTR4A7Total.Rows[0].Cells[0].Value = "TOTAL";
                }
                else
                {
        ...
        private void dgvGSTR4A7_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                if (e.KeyCode == Keys.Delete)
                {
                    ...
                    try
                    {
                        ...
                        if (dgvGSTR4A7.Rows.Count > 0)
                        {
                            // DELETE SELECTED CELL IN GRID
                            foreach (DataGridViewCell oneCell in dgvGSTR4A7.SelectedCells)
                            {
                ...
                if (e.KeyCode == Keys.V)
                {
                    ...
                    if (dgvGSTR4A7.RowCount > 0) // IF GRID IS NOT NULL AND PAST ONLY ON SELECTED CELLS
                    {
                        foreach (DataGridViewCell oneCell in dgvGSTR4A7.SelectedCells)
                        {
                            if (oneCell.Selected)
                    ...
                    foreach (string line in lines)
                    {
                        ...
                        {
                            // disable main grid
                            DisableControls(dgvGSTR4A7);

                            gRowNo = dgvGSTR4A7.Rows.Count - 1;
                            int no = tmp;

                            if (iRow > gRowNo - 1)
                            {
                                DataTable dtDGV = new DataTable();
                                //dtDGV = dgvGSTR4A7.DataSource as DataTable;
                                ...
                                foreach (DataGridViewRow dr in dgvGSTR4A7.Rows)
                                {
                                    if (dr.Index != dgvGSTR4A7.Rows.Count - 1) // DON'T ADD LAST ROW
                                    {
                                        // SET CHECK BOX VALUE
                                        rowValue[0] = "False";
                            ...
                            else
                            {
                                ...
                                if (line.Length > 0)
                                {
                                    ...
                                    for (int i = 0; i < sCells.GetLength(0); ++i)
                                    {
                                        ...
                                        if (iCol + i < this.dgvGSTR4A7.ColumnCount && i < 12)
                                        {
                                            // SKIP CHECK BOX COLUMN AND SEQUANCE COLUMN TO PASTE DATA
                                            if (iCol == 0)
                                                oCell = dgvGSTR4A7[iCol + i + 2, iRow];
                                            else if (iCol == 1)
                                                oCell = dgvGSTR4A7[iCol + i + 1, iRow];
                                            else
                                                oCell = dgvGSTR4A7[iCol + i, iRow];

                                            sCells[i] = sCells[i].Trim().Replace(",", "");
                                            if (oCell.ColumnIndex != 0)
                                            {
                                                if (dgvGSTR4A7.Columns[oCell.ColumnIndex].Name != "colChk" && dgvGSTR4A7.Columns[oCell.ColumnIndex].Name != "colSequence")
                                                {
                                                    #region VALIDATION
                                                    if (sCells[i].ToString().Trim() == "") { dgvGSTR4A7.Rows[iRow].Cells[oCell.ColumnIndex].Value = DBNull.Value; }
                                                    else
                                                    {
                                                        if (oCell.ColumnIndex >= 2 && oCell.ColumnIndex <= 13)
                                                        {
                                                            if (chkCellValue(sCells[i].Trim(), oCell.ColumnIndex))
                                                                dgvGSTR4A7.Rows[iRow].Cells[oCell.ColumnIndex].Value = sCells[i].Trim();
                                                            else
                                                                dgvGSTR4A7.Rows[iRow].Cells[oCell.ColumnIndex].Value = DBNull.Value;
                                                        }
                                                        else { dgvGSTR4A7.Rows[iRow].Cells[oCell.ColumnIndex].Value = sCells[i].Trim(); }
                                                    }
                                                    #endregion
                                                }
                                            }
                                            else
                                            {
                                                if (iCol > i)
                                                {
                                                    for (int j = oCell.ColumnIndex; j < dgvGSTR4A7.Columns.Count; j++)
                                                    {
                                                        #region VALIDATION
                                                        if (sCells[i].ToString().Trim() == "") { dgvGSTR4A7.Rows[iRow].Cells[j].Value = DBNull.Value; }
                                                        else
                                                        {
                                                            if (j >= 2 && j <= 13)
                                                            {
                                                                if (chkCellValue(sCells[i].Trim(), j))
                                                                    dgvGSTR4A7.Rows[iRow].Cells[j].Value = sCells[i].Trim();
                                                                else
                                                                    dgvGSTR4A7.Rows[iRow].Cells[j].Value = DBNull.Value;
                                                            }
                                                            else { dgvGSTR4A7.Rows[iRow].Cells[j].Value = sCells[i].Trim(); }
                                                        }
                                                        #endregion
                    ...
                    for (int i = 0; i < dgvGSTR4A7.Rows.Count - 1; i++)
                    {
                        dgvGSTR4A7.Rows[i].Cells["colSequence"].Value = i + 1;
                    }
                    #endregion

                    // enable control
                    EnableControls(dgvGSTR4A7);
                }
                ...
                foreach (string line in lines)
                {
                    ...
                    if (cnt >= lineNo)
                    {
                        if (line != "" && line.Length > 0)
                        {
                            ...
                            {
                                // CHECK GRID COLUMN COUNT
                                if (iCol + i < this.dgvGSTR4A7.ColumnCount && colNo < 13)
                                {
                                    // SKIP CHECK BOX COLUMN AND SEQUANCE COLUMN TO PASTE DATA
                                    if (iCol == 0)
                                        colNo = iCol + i + 2;
                                    ...
                                    else
                                    {
                                        ...
                                        if (iCol > i)
                                        {
                                            for (int j = colNo; j < dgvGSTR4A7.Columns.Count; j++)
                                            {
                                                #region VALIDATION
        ...
        public bool IsValidateData()
        {
            try
            {
                int _cnt = 0, sj = 0;
                string _str = "";
                dgvGSTR4A7.CurrentCell = dgvGSTR4A7.Rows[0].Cells[0];
                dgvGSTR4A7.AllowUserToAddRows = false;

                #region GSTN Number
                sj = 2;
                List<DataGridViewRow> list = dgvGSTR4A7.Rows
                ...
                if (list.Count > 0)
                {
                    ...
                    {
                        dgvGSTR4A7.Rows[list[i].Cells[sj].RowIndex].Cells[sj].Style.BackColor = Color.Red;
                    }
                    _cnt += 1;
                    _str += _cnt + ") Please enter proper GSTN of deductor.\n";
                }
                list = dgvGSTR4A7.Rows
                       .OfType<DataGridViewRow>()
                       .Where(x => true == Utility.IsGSTN(Convert.ToString(x.Cells[sj].Value)))
                       .Select(x => x)
                       .ToList();
                for (int i = 0; i < list.Count; i++)
                {
                    dgvGSTR4A7.Rows[list[i].Cells[sj].RowIndex].Cells[sj].Style.BackColor = Color.White;
                }
                #endregion

                #region Invoice/ Document Date
                sj = 4;
                ...
                if (list.Count > 0)
                {
                    ...
                    _cnt += 1;
                    _str += _cnt + ") Please enter proper invoice/ document date.\n";
                }
                list = dgvGSTR4A7.Rows
                       .OfType<DataGridViewRow>()
                       .Where(x => true == Utility.IsDate(Convert.ToString(x.Cells[sj].Value)))
                ...
                if (list.Count > 0)
                {
                    ...
                    _cnt += 1;
                    _str += _cnt + ") Please enter proper invoice/ document value.\n";
                }
                list = dgvGSTR4A7.Rows
                       .OfType<DataGridViewRow>()
                       .Where(x => true == Utility.IsNumber(Convert.ToString(x.Cells[sj].Value)))
                ...
                #region Date of Payment to deductee
                sj = 6;
                list = null;//dd-MM-yyyy
                list = dgvGSTR4A7.Rows
                       .OfType<DataGridViewRow>()
                ...
                if (list.Count > 0)
                {
                    ...
                    _cnt += 1;
                    _str += _cnt + ") Please enter proper date of payment to deductee.\n";
                }
                list = dgvGSTR4A7.Rows
                       .OfType<DataGridViewRow>()
                       .Where(x => true == Utility.IsDate(Convert.ToString(x.Cells[sj].Value)))
                ...
                #region Value on which TDS has been deducted
                sj = 7;
                list = null;
                list = dgvGSTR4A7.Rows
                       .OfType<DataGridViewRow>()
                ...
                if (list.Count > 0)
                {
                    ...
                    _cnt += 1;
                    _str += _cnt + ") Please enter proper value on which TDS has been deducted.\n";
                }
                list = dgvGSTR4A7.Rows
                       .OfType<DataGridViewRow>()
                       .Where(x => true == Utility.IsNumber(Convert.ToString(x.Cells[sj].Value)))
                ...
                dgvGSTR4A7.AllowUserToAddRows = true;
        ...
        private Boolean chkCellValue(string cellValue, int cNo)
        {
            try
            {
                if (cellValue.Trim() != "" || cNo == 17)// NOT EQUEL BLANK
                {
                    ...
                    else if (cNo == 5 || cNo == 7 || cNo == 9 || cNo == 11 || cNo == 13) // value
                    {
                    ...
                    else if (cNo == 8 || cNo == 10 || cNo == 12) // Rate
                    {
                        if (Utility.IsNumber(cellValue))
                        {
        ...
        private void dgvGSTR4A7_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (e.RowIndex >= 0)
                {
                    if (cNo == 2 || cNo == 4 || cNo == 6 || cNo == 8 || cNo == 10 || cNo == 12)
                    {
                        if (!chkCellValue(Convert.ToString(dgvGSTR4A7.Rows[e.RowIndex].Cells[cNo].Value).Trim(), cNo))
                            dgvGSTR4A7.Rows[e.RowIndex].Cells[cNo].Value = "";
                    }
                    else if (cNo == 3 || cNo == 5 || cNo == 7 || cNo == 9 || cNo == 11 || cNo == 13) // value
                    {
                        if (chkCellValue(Convert.ToString(dgvGSTR4A7.Rows[e.RowIndex].Cells[cNo].Value).Trim(), cNo))
                        {
                        ...
                        else { dgvGSTR4A7.Rows[e.RowIndex].Cells[cNo].Value = ""; }
                    }
                    else
                    {
        ...
        public void Save()
        {
            try
            {
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    Query = "Delete from GSTR4AFormPartB7 where Fld_Month='" + CommonHelper.SelectedMonth + "' AND Fld_FinancialYear = '" + CommonHelper.ReturnYear + "'";
                    ...
                    _Result = objGSTR4A.GSTR4A7BulkEntry(dt, Convert.ToString(CommonHelper.StatusText));
                    ...
                    if (_Result == 1)
                    {
                        ...
                        if (dgvGSTR4A7Total.Rows.Count == 1)
                        {
                            foreach (DataGridViewRow dr in dgvGSTR4A7Total.Rows)
                            {
                                for (int i = 0; i < dr.Cells.Count; i++)
                                {
                        ...
                        _Result = objGSTR4A.GSTR4A7BulkEntry(dt, "Total");
                        if (_Result == 1)
                        {
                            load(false, 0, Convert.ToString(""));
                            ProgressBar.Visible = false;
        ...
        public void Delete()
        {
            try
            {
                ...
                if (dgvGSTR4A7.CurrentCell.RowIndex == 0 && dgvGSTR4A7.CurrentCell.ColumnIndex == 0)
                {
                    dgvGSTR4A7.CurrentCell = dgvGSTR4A7.Rows[0].Cells[1];
                }
                else { dgvGSTR4A7.CurrentCell = dgvGSTR4A7.Rows[0].Cells[0]; }
                ...
                if (dgvGSTR4A7.Rows.Count > 1)
                {
                    ...
                    for (int i = 0; i < dgvGSTR4A7.Rows.Count - 1; i++)
                    {
                        if (dgvGSTR4A7[0, i].Value != null && dgvGSTR4A7[0, i].Value.ToString() != "")
                        {
                            if (Convert.ToBoolean(dgvGSTR4A7[0, i].Value) == true)
                            {
                                // ADD ROW TO OBJECT IF ROW IS SELECTED
                                flgSelect = true;
                                toDelete.Add(dgvGSTR4A7.Rows[i]);
                            }
                        }
                    }
                    #endregion
                    ...
                    if (flgChk || flgSelect)
                    {
                        ...
                        if (result == DialogResult.Yes)
                        {
                            ...
                            else if (flgSelect == true)
                            {
                                ...
                                {
                                    dgvGSTR4A7.Rows.RemoveAt(row.Index);
                                    Application.DoEvents();
                            ...
                            for (int i = 0; i < dgvGSTR4A7.Rows.Count - 1; i++)
                            {
                                dgvGSTR4A7.Rows[i].Cells["colSequence"].Value = Convert.ToString(i + 1);
                            }
                            ...
                            dgvGSTR4A7.Columns[0].HeaderText = "Check All";
                            #endregion
                        }
                    }
            ...
            try
            {
                ...
                if (file.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    ...
                    if (fileExt.CompareTo(".xls") == 0 || fileExt.CompareTo(".xlsx") == 0)
                    {
                        ...
                        DataTable dt = new DataTable();
                        dt = (DataTable)dgvGSTR4A7.DataSource;
            ...
            using (OleDbConnection con = new OleDbConnection(conn))
            {
                try
                {
                    try
                    {
                        ...
                        OleDbDataAdapter oleAdpt = new OleDbDataAdapter("select * from [B2B_4A7$]", con);
                    ...
                    if (dtexcel != null && dtexcel.Rows.Count > 0)
                    {
                        ...
                        for (int i = 1; i < dgvGSTR4A7.Columns.Count; i++)
                        {
                            Boolean flg = false;
                            for (int j = 0; j < dtexcel.Columns.Count; j++)
                            {
                                // CHECK GRID COLUMN IS PRESENT OR NOT IN IMPORTED EXCEL
                                if (dgvGSTR4A7.Columns[i].HeaderText.Replace(".", "#").Replace(" ", "").ToLower().Trim() == dtexcel.Columns[j].ColumnName.Replace(" ", "").ToLower().Trim())
                                {
                                    // IF GRID COLUMN PRESENT IN EXCEL THEN ITS INDEX AS PAR GRID COLUMN INDEX
                                    flg = true;
                                    dtexcel.Columns[j].SetOrdinal(dgvGSTR4A7.Columns[i].Index - 1);
                                    break;
                                }
                            }
                            if (flg == false)
                        ...
                        if (dtexcel.Columns.Count >= dgvGSTR4A7.Columns.Count - 2)
                        {
                            for (int i = dtexcel.Columns.Count - 1; i > (dgvGSTR4A7.Columns.Count - 2); i--)
                            {
        ...
        public void ExportExcel()
        {
            try
            {
                if (dgvGSTR4A7.Rows.Count > 1)
                {
                    ...
                    for (int i = 1; i < dgvGSTR4A7.Columns.Count; i++)
                    {
                        newWS.Cells[1, i] = dgvGSTR4A7.Columns[i].HeaderText.ToString();
                    ...
                    Excel.Range headerRange = (Excel.Range)newWS.get_Range((Excel.Range)newWS.Cells[1, 1], (Excel.Range)newWS.Cells[1, dgvGSTR4A7.Columns.Count - 1]);
                    ...
                    object[,] arr = new object[dgvGSTR4A7.Rows.Count - 1, dgvGSTR4A7.Columns.Count];
                    ...
                    if (CommonHelper.IsLicence)
                    {
                        ...
                        for (int i = 0; i < dgvGSTR4A7.Rows.Count - 1; i++)
                        {
                            ...
                            ProgressBar.Visible = true;
                            if (i == 0)
                                load(true, dgvGSTR4A7.Rows.Count - 1, i.ToString());
                            else
                                load(false, dgvGSTR4A7.Rows.Count - 1, i.ToString());

                            for (int j = 1; j < dgvGSTR4A7.Columns.Count; j++)
                            {
                                arr[i, j - 1] = dgvGSTR4A7.Rows[i].Cells[j].Value.ToString();
                            }
                        }
                    }
                    else
                    ...
                    Excel.Range bottom = (Excel.Range)newWS.Cells[dgvGSTR4A7.Rows.Count, dgvGSTR4A7.Columns.Count];
            ...
            using (TextFieldParser csvReader = new TextFieldParser(csv_file_path))
            {
                try
                {
                    ...
                    for (int i = 1; i < dgvGSTR4A7.Columns.Count; i++)
                    {
                        ...
                        {
                            // CHECK GRID COLUMN IS PRESENT OR NOT IN IMPORTED EXCEL
                            if (dgvGSTR4A7.Columns[i].HeaderText.Replace(" ", "") == csvData.Columns[j].ColumnName.Replace(" ", "").Trim())
                            {
                                // IF GRID COLUMN PRESENT IN EXCEL THEN ITS INDEX AS PAR GRID COLUMN INDEX
                                flg = true;
                                csvData.Columns[j].SetOrdinal(dgvGSTR4A7.Columns[i].Index - 1);
                                break;
                            }
                        }
                        if (flg == false)
                    ...
                    if (csvData.Columns.Count >= dgvGSTR4A7.Columns.Count - 2)
                    {
                        for (int i = csvData.Columns.Count - 1; i > (dgvGSTR4A7.Columns.Count - 2); i--)
                        {
        ...
        public void ExportCSV()
        {
            try
            {
                if (dgvGSTR4A7.Rows.Count > 1)
                {
                    ...
                    for (int i = 1; i < dgvGSTR4A7.Columns.Count; i++)
                    {
                        csv += dgvGSTR4A7.Columns[i].HeaderText + ',';
                    }
        ...
        public void ExportPDF()
        {
            try
            {
                if (dgvGSTR4A7.Rows.Count > 1)
                {
                    ...
                    PdfPTable pdfTable = new PdfPTable(dgvGSTR4A7.ColumnCount - 1);
                    ...
                    pdfTable = AssignHeader(pdfTable, "7. TDS Credit received");
                    #endregion

                    #region ADDING HEADER ROW
                    int i = 0;
                    foreach (DataGridViewColumn column in dgvGSTR4A7.Columns)
                    {
                        if (i != 0)
                        {
                    ...
                    {
                        // FOR LICENCE ALLOWS TO EXPORT ALL RECORDS
                        foreach (DataGridViewRow row in dgvGSTR4A7.Rows)
                        {
                            i = 0;
                            ...
                            ProgressBar.Visible = true;
                            if (sj == 0)
                                load(true, dgvGSTR4A7.Rows.Count - 1, sj.ToString());
                            else
                                load(false, dgvGSTR4A7.Rows.Count - 1, sj.ToString());
        ...
        public PdfPTable AssignHeader(PdfPTable pdfTable, string HeaderName)
        {
            try
            {
                ...
                ce1.Colspan = dgvGSTR4A7.Columns.Count;
                ...
                ce2.Colspan = dgvGSTR4A7.Columns.Count;
                ce2.BorderWidth = 0;
        ...
        public void SetGridViewColor()
        {
            try
            {
                ...
                dgvGSTR4A7.AutoGenerateColumns = false;
                ...
                this.dgvGSTR4A7.Width = Convert.ToInt32(Screen.PrimaryScreen.WorkingArea.Width * (0.96));
                this.dgvGSTR4A7Total.Width = Convert.ToInt32(Screen.PrimaryScreen.WorkingArea.Width * (0.96));

                // SET HEIGHT OF MAIN GRID
                this.dgvGSTR4A7.Height = Convert.ToInt32(Screen.PrimaryScreen.WorkingArea.Height * (0.65));
                this.dgvGSTR4A7Total.Height = 40;

                // SET LOCATION OF HEADER,LOADING PIC, CHECKBOX AND MAIN AND TOTAL GRID
                this.panel1.Location = new System.Drawing.Point(12, 0);
                this.dgvGSTR4A7.Location = new System.Drawing.Point(12, Convert.ToInt32(Screen.PrimaryScreen.WorkingArea.Height * (0.05)));
                this.dgvGSTR4A7Total.Location = new System.Drawing.Point(12, Convert.ToInt32(Screen.PrimaryScreen.WorkingArea.Height * (0.71)));
                ...
                dgvGSTR4A7.EnableHeadersVisualStyles = false;
                dgvGSTR4A7.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(23, 196, 187);
                dgvGSTR4A7.ColumnHeadersDefaultCellStyle.ForeColor = Color.Black;

                this.dgvGSTR4A7.CellBorderStyle = DataGridViewCellBorderStyle.Single;
                this.dgvGSTR4A7.RowHeadersBorderStyle = DataGridViewHeaderBorderStyle.Single;
                this.dgvGSTR4A7.ColumnHeadersBorderStyle = DataGridViewHeaderBorderStyle.Single;
        ...
        private void txtSearch_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ((DataTable)dgvGSTR4A7.DataSource).DefaultView.RowFilter = string.Format("colSequence like '%{0}%' or colGSTINDeductor like '%{1}%' or colInvoiceDocNo like '%{2}%' or colInvoiceDocDate like '%{3}%' or colInvoiceDocValue like '%{4}%' or colDateOfPayment like '%{5}%' or colValueOnTDS like '%{6}%' or colTDSIGSTRate  like '%{7}%' or colTDSIGSTAmt like '%{8}%' or colTDSCGSTRate like '%{9}%' or colTDSCGSTAmt like '%{10}%' or colTDSSGSTRate like '%{11}%' or colTDSSGSTAmt like '%{12}%'", txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"));
            }
            catch (Exception ex)
            {
                MessageBox.Show("Error : " + ex.Message);
        ...
        private void dgvGSTR4A7_UserAddedRow(object sender, DataGridViewRowEventArgs e)
        {
            try
            {
                // SET INDEX OF USER ADDED ROW IN MAIN GRID
                dgvGSTR4A7.Rows[e.Row.Index - 1].Cells[1].Value = e.Row.Index;
            }
            catch (Exception ex)
            {
                MessageBox.Show("Error : " + ex.Message);
        ...
        private void dgvGSTR4A7_UserDeletingRow(object sender, DataGridViewRowCancelEventArgs e)
        {
            try
            {
                // SET SEQUNCING AFTER USER DELETING ROW IN GRID
                for (int i = e.Row.Index; i < dgvGSTR4A7.Rows.Count - 1; i++)
                {
                    dgvGSTR4A7.Rows[i].Cells["colSequence"].Value = i;
                }
                // TOTAL CALCULATION
                int[] colNo = { 3, 5, 7, 9, 11, 13 };
                GetTotal(colNo);
        ...
        private void dgvGSTR4A7_Scroll(object sender, ScrollEventArgs e)
        {
            try
            {
                // SET TOTAL GRID OFFSET AS PAR MAIN GRID SCROLL
                this.dgvGSTR4A7Total.HorizontalScrollingOffset = this.dgvGSTR4A7.HorizontalScrollingOffset;
            }
            catch (Exception ex)
            {
                MessageBox.Show("Error : " + ex.Message);
        ...
        private void dgvGSTR4A7Total_Scroll(object sender, ScrollEventArgs e)
        {
            try
            {
                // SET TOTAL GRID OFFSET AS PAR MAIN GRID SCROLL
                this.dgvGSTR4A7.HorizontalScrollingOffset = this.dgvGSTR4A7Total.HorizontalScrollingOffset;
            }
            catch (Exception ex)
            {
                MessageBox.Show("Error : " + ex.Message);
        ...
        private void dgvGSTR4A7_ColumnHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            try
            {
                // CHECK FIRST COLUMN HEADER PRESSED AND MAIN GRID HAVING RECORDS
                if (e.ColumnIndex == 0 && dgvGSTR4A7.Rows.Count > 1)
                {
                    // CHECK AND UNCHECK CHECK BOX OF HEADER FOR SELECTING AND UNSELECTING ALL RECORDS
                    if (dgvGSTR4A7.Columns[e.ColumnIndex].HeaderText == "Check All")
                        ckboxHeader.Checked = true;
                    else if (dgvGSTR4A7.Columns[e.ColumnIndex].HeaderText == "Uncheck All")
                        ckboxHeader.Checked = false;
                }
            }
            catch (Exception ex)
            ...
            try
            {
                ...
                if (dgvGSTR4A7.Rows.Count > 1)
                {
                    ...
                    if (ckboxHeader.Checked)
                    {
                        ...
                        for (int i = 0; i < dgvGSTR4A7.Rows.Count - 1; i++)
                        {
                            dgvGSTR4A7.Rows[i].Cells[0].Value = "True";
                            Application.DoEvents();
                        }

                        // CHANGE HEADER TEXT AND WIDTH OF COLUMN AND POSITION OF CHECK BOX OF CHECK ALL COLUMN
                        //dgvGSTR4A7.Columns[0].DefaultCellStyle.NullValue = true;
                        dgvGSTR4A7.Columns[0].HeaderText = "Uncheck All";
                    }
                    else if (ckboxHeader.Checked == false)
                    {
                        ...
                        for (int i = 0; i < dgvGSTR4A7.Rows.Count - 1; i++)
                        {
                            dgvGSTR4A7.Rows[i].Cells[0].Value = "False";
                            Application.DoEvents();
                        }

                        // CHANGE HEADER TEXT AND WIDTH OF COLUMN AND POSITION OF CHECK BOX OF CHECK ALL COLUMN
                        //dgvGSTR4A7.Columns[0].DefaultCellStyle.NullValue = false;
                        dgvGSTR4A7.Columns[0].HeaderText = "Check All";
                    }
                    pbGSTR1.Visible = false;
                }
        ...
        private void DisableControls(Control con)
        {
            ...
            {
                if (c.Name != "frmGSTR4A7" && c.Name != "dgvGSTR4A7Total")
                    DisableControls(c);
            }
            con.Enabled = false;
        ...
        private void dgvGSTR4A7Total_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            try
            {
                if (dgvGSTR4A7Total.Rows.Count > 0)
                {
                    DataGridViewRow row = this.dgvGSTR4A7Total.RowTemplate;
        ...
        private void frmGSTR4A7_FormClosed(object sender, FormClosedEventArgs e)
        {
