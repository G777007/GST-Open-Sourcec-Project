...
{
    public partial class SPQGSTR2AB2B : Form
    {
        ...
        public SPQGSTR2AB2B()
        {
            ...
            // TOTAL CALCULATION
            string[] colNo = { "colInvoiceNo", "colInvoiceTaxableVal", "colIntTax", "colCtrlTax", "colStateTax", "colCessTax" };
            GetTotal(colNo);
            BindFilter();
            ((SPQMDI)Application.OpenForms["SPQMDI"]).SetReturnName(CommonHelper.ReturnName);

            dgvGSTR2A3.ColumnHeadersDefaultCellStyle.BackColor = Color.Navy;
            dgvGSTR2A3.EnableHeadersVisualStyles = false;
            dgvGSTR2A3.ColumnHeadersDefaultCellStyle.Font = new System.Drawing.Font("Verdana", 8, FontStyle.Bold);
            dgvGSTR2A3.ColumnHeadersDefaultCellStyle.ForeColor = Color.White;
            dgvGSTR2A3.Font = new System.Drawing.Font("Verdana", 8, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
        ...
        private void BindFilter()
        {
            try
            {
                ...
                for (int i = 0; i < dgvGSTR2A3.Columns.Count; i++)
                {
                    if (i > 1)
                    {
                        string HeaderText = dgvGSTR2A3.Columns[i].HeaderText;
                        string Name = dgvGSTR2A3.Columns[i].Name;
        ...
        private void PrefillData()
        {
            try
            {
                ...
                foreach (DataGridViewColumn col in dgvGSTR2A3.Columns)
                {
        ...
        private void GetData()
        {
            ...
            {
                DataTable dt = new DataTable();
                string Query = "Select * from SPQR2AInwardSupplies where Fld_Month='" + CommonHelper.SelectedMonth + "' AND Fld_FinancialYear = '" + CommonHelper.ReturnYear + "' and Fld_FileStatus != 'Total'";//and Fld_ReverseCharge = 'False'
                Application.DoEvents();
            ...
            try
            {
                if (dgvGSTR2A3.Rows.Count > 0)
                {
                    ...
                    if (dgvGSTR2A3Total.Rows.Count == 0)
                    {
                        ...
                        foreach (DataGridViewRow drn in dgvGSTR2A3.Rows)
                        {
                            rowValue[0] = "False";
                        ...
                        var result = (from row in dt.AsEnumerable()
                                      where row.Field<string>("colInvoiceNo") != "" && row.Field<string>("colGSTIN") != ""
                                      group row by new { colGSTIN = row.Field<string>("colGSTIN"), colInvNo = row.Field<string>("colInvoiceNo") } into grp
                                      select new
                                      {
                        ...
                        //dr["colTInvoiceNo"] = dgvGSTR2A3.Rows.Cast<DataGridViewRow>().Where(x => Convert.ToString(x.Cells["colInvoiceNo"].Value).Trim() != "").GroupBy(x => x.Cells["colInvoiceNo"].Value).Select(x => x.First()).Distinct().Count();
                        dr["colTInvoiceValue"] = dgvGSTR2A3.Rows.Cast<DataGridViewRow>().Where(x => x.Cells["colInvoiceValue"].Value != null).Sum(x => x.Cells["colInvoiceValue"].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells["colInvoiceValue"].Value)).ToString();
                        dr["colTInvoiceTaxableVal"] = dgvGSTR2A3.Rows.Cast<DataGridViewRow>().Where(x => x.Cells["colInvoiceTaxableVal"].Value != null).Sum(x => x.Cells["colInvoiceTaxableVal"].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells["colInvoiceTaxableVal"].Value)).ToString();
                        dr["colTIntTax"] = dgvGSTR2A3.Rows.Cast<DataGridViewRow>().Where(x => x.Cells["colIntTax"].Value != null).Sum(x => x.Cells["colIntTax"].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells["colIntTax"].Value)).ToString();
                        dr["colTCtrlTax"] = dgvGSTR2A3.Rows.Cast<DataGridViewRow>().Where(x => x.Cells["colCtrlTax"].Value != null).Sum(x => x.Cells["colCtrlTax"].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells["colCtrlTax"].Value)).ToString();
                        dr["colTStateTax"] = dgvGSTR2A3.Rows.Cast<DataGridViewRow>().Where(x => x.Cells["colStateTax"].Value != null).Sum(x => x.Cells["colStateTax"].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells["colStateTax"].Value)).ToString();
                        dr["colTCessTax"] = dgvGSTR2A3.Rows.Cast<DataGridViewRow>().Where(x => x.Cells["colCessTax"].Value != null).Sum(x => x.Cells["colCessTax"].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells["colCessTax"].Value)).ToString();
                    ...
                    else if (dgvGSTR2A3Total.Rows.Count == 1)
                    {
                        ...
                        foreach (var item in colNo)
                        {
                            if (item == "colInvoiceNo")
                            {
                                ...
                                if (result != null && result.Count > 0)
                                    dgvGSTR2A3Total.Rows[0].Cells["colTInvoiceNo"].Value = result.Count;
                                else
                                    dgvGSTR2A3Total.Rows[0].Cells["colTInvoiceNo"].Value = 0;
                                #endregion
                            }
                            //dgvGSTR2A3Total.Rows[0].Cells["colTInvoiceNo"].Value = dgvGSTR2A3.Rows.Cast<DataGridViewRow>().Where(x => Convert.ToString(x.Cells["colInvoiceNo"].Value).Trim() != "").GroupBy(x => x.Cells["colInvoiceNo"].Value).Select(x => x.First()).Distinct().Count();
                            else if (item == "colInvoiceValue")
                                dgvGSTR2A3Total.Rows[0].Cells["colTInvoiceValue"].Value = dgvGSTR2A3.Rows.Cast<DataGridViewRow>().Where(x => x.Cells["colInvoiceValue"].Value != null).Sum(x => x.Cells["colInvoiceValue"].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells["colInvoiceValue"].Value)).ToString();
                            else if (item == "colInvoiceTaxableVal")
                                dgvGSTR2A3Total.Rows[0].Cells["colTInvoiceTaxableVal"].Value = dgvGSTR2A3.Rows.Cast<DataGridViewRow>().Where(x => x.Cells["colInvoiceTaxableVal"].Value != null).Sum(x => x.Cells["colInvoiceTaxableVal"].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells["colInvoiceTaxableVal"].Value)).ToString();
                            else if (item == "colIntTax")
                                dgvGSTR2A3Total.Rows[0].Cells["colTIntTax"].Value = dgvGSTR2A3.Rows.Cast<DataGridViewRow>().Where(x => x.Cells["colIntTax"].Value != null).Sum(x => x.Cells["colIntTax"].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells["colIntTax"].Value)).ToString();
                            else if (item == "colCtrlTax")
                                dgvGSTR2A3Total.Rows[0].Cells["colTCtrlTax"].Value = dgvGSTR2A3.Rows.Cast<DataGridViewRow>().Where(x => x.Cells["colCtrlTax"].Value != null).Sum(x => x.Cells["colCtrlTax"].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells["colCtrlTax"].Value)).ToString();
                            else if (item == "colStateTax")
                                dgvGSTR2A3Total.Rows[0].Cells["colTStateTax"].Value = dgvGSTR2A3.Rows.Cast<DataGridViewRow>().Where(x => x.Cells["colStateTax"].Value != null).Sum(x => x.Cells["colStateTax"].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells["colStateTax"].Value)).ToString();
                            else if (item == "colCessTax")
                                dgvGSTR2A3Total.Rows[0].Cells["colTCessTax"].Value = dgvGSTR2A3.Rows.Cast<DataGridViewRow>().Where(x => x.Cells["colCessTax"].Value != null).Sum(x => x.Cells["colCessTax"].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells["colCessTax"].Value)).ToString();
                        }
                        #endregion
                    }
        ...
        private void dgvGSTR24A_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                if (e.KeyCode == Keys.Delete)
                {
                    ...
                    try
                    {
                        ...
                        if (dgvGSTR2A3.Rows.Count > 0)
                        {
                            ...
                            foreach (DataGridViewCell oneCell in dgvGSTR2A3.SelectedCells)
                            {
                ...
                if (e.KeyCode == Keys.V)
                {
                    ...
                    if (dgvGSTR2A3.RowCount > 0) // IF GRID IS NOT NULL AND PAST ONLY ON SELECTED CELLS
                    {
                        foreach (DataGridViewCell oneCell in dgvGSTR2A3.SelectedCells)
                        {
                            if (oneCell.Selected)
                    ...
                    foreach (string line in lines)
                    {
                        ...
                        {
                            // disable main grid
                            DisableControls(dgvGSTR2A3);

                            gRowNo = dgvGSTR2A3.Rows.Count - 1;
                            int no = tmp;
                            ...
                            if (iRow > gRowNo - 1)
                            {
                                ...
                                foreach (DataGridViewRow dr in dgvGSTR2A3.Rows)
                                {
                            ...
                            else
                            {
                                ...
                                if (line.Length > 0)
                                {
                                    ...
                                    for (int i = 0; i < sCells.GetLength(0); ++i)
                                    {
                                        ...
                                        if (iCol + i < this.dgvGSTR2A3.ColumnCount && i < 14)
                                        {
                                            // SKIP CHECK BOX COLUMN AND SEQUANCE COLUMN TO PASTE DATA
                                            if (iCol == 0)
                                                oCell = dgvGSTR2A3[iCol + i + 2, iRow];
                                            else if (iCol == 1)
                                                oCell = dgvGSTR2A3[iCol + i + 1, iRow];
                                            else
                                                oCell = dgvGSTR2A3[iCol + i, iRow];

                                            sCells[i] = sCells[i].Trim().Replace(",", "");
                                            if (oCell.ColumnIndex != 0)
                                            {
                                                if (dgvGSTR2A3.Columns[oCell.ColumnIndex].Name != "colChk" && dgvGSTR2A3.Columns[oCell.ColumnIndex].Name != "colSequence")
                                                {
                                                    #region VALIDATION
                                                    if (sCells[i].ToString().Trim() == "") { dgvGSTR2A3.Rows[iRow].Cells[oCell.ColumnIndex].Value = DBNull.Value; }
                                                    else
                                                    {
                                                        if (oCell.ColumnIndex >= 2 && oCell.ColumnIndex <= 15)
                                                        {
                                                            if (chkCellValue(sCells[i].Trim(), dgvGSTR2A3.Columns[oCell.ColumnIndex].Name))
                                                                dgvGSTR2A3.Rows[iRow].Cells[oCell.ColumnIndex].Value = sCells[i].Trim();
                                                            else
                                                                dgvGSTR2A3.Rows[iRow].Cells[oCell.ColumnIndex].Value = DBNull.Value;
                                                        }
                                                        else { dgvGSTR2A3.Rows[iRow].Cells[oCell.ColumnIndex].Value = sCells[i].Trim(); }
                                                    }
                                                    #endregion
                                                }
                                            }
                                            else
                                            {
                                                if (iCol > i)
                                                {
                                                    for (int j = oCell.ColumnIndex; j < dgvGSTR2A3.Columns.Count; j++)
                                                    {
                                                        //dgvGSTR15.Rows[iRow].Cells[j].Value = sCells[i].Trim();

                                                        #region VALIDATION
                                                        if (sCells[i].ToString().Trim() == "") { dgvGSTR2A3.Rows[iRow].Cells[j].Value = DBNull.Value; }
                                                        else
                                                        {
                                                            if (j >= 2 && j <= 15)
                                                            {
                                                                if (chkCellValue(sCells[i].Trim(), dgvGSTR2A3.Columns[j].Name))
                                                                    dgvGSTR2A3.Rows[iRow].Cells[j].Value = sCells[i].Trim();
                                                                else
                                                                    dgvGSTR2A3.Rows[iRow].Cells[j].Value = DBNull.Value;
                                                            }
                                                            else { dgvGSTR2A3.Rows[iRow].Cells[j].Value = sCells[i].Trim(); }
                                                        }
                                                        #endregion
                    ...
                    for (int i = 0; i < dgvGSTR2A3.Rows.Count - 1; i++)
                    {
                        dgvGSTR2A3.Rows[i].Cells["colSequence"].Value = i + 1;
                    }
                    #endregion

                    // ENABLE CONTROL
                    EnableControls(dgvGSTR2A3);
                    pbGSTR1.Visible = false;
                }
        ...
        private void GridRowPaste(DataTable dtDGV, int lineNo, int iCol, string[] lines)
        {
            try
            {
                ...
                foreach (string line in lines)
                {
                    ...
                    if (cnt >= lineNo)
                    {
                        if (line != "" && line.Length > 0)
                        {
                            ...
                            {
                                // CHECK GRID COLUMN COUNT
                                if (iCol + i < this.dgvGSTR2A3.ColumnCount && colNo < 15)
                                {
                                    // SKIP CHECK BOX COLUMN AND SEQUANCE COLUMN TO PASTE DATA
                                    if (iCol == 0)
                                        colNo = iCol + i + 2;
                                    ...
                                    if (colNo != 0)
                                    {
                                        if (dt.Columns[colNo].ColumnName != "colChk")
                                        {
                                            ...
                                            else
                                            {
                                                if (colNo >= 2 && colNo <= 15)
                                                {
                                                    if (chkCellValue(sCells[i].Trim(), dgvGSTR2A3.Columns[colNo].Name))
                                    ...
                                    else
                                    {
                                        ...
                                        if (iCol > i)
                                        {
                                            for (int j = colNo; j < dgvGSTR2A3.Columns.Count; j++)
                                            {
                                                #region VALIDATION
                ...
                // TOTAL CALCULATION
                string[] colGroup = { "colInvoiceNo", "colInvoiceTaxableVal", "colIntTax", "colCtrlTax", "colStateTax", "colCessTax" };
                GetTotal(colGroup);
        ...
        private void dgvGSTR2A4_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                string cNo = dgvGSTR2A3.Columns[e.ColumnIndex].Name;

                if (e.RowIndex >= 0)
                {
                    if (cNo == "colGSTIN" || cNo == "colName" || cNo == "colInvoiceDate" || cNo == "colRate" || cNo == "colPOS" || cNo == "colInvoiceType") // Other
                    {
                        if (!chkCellValue(Convert.ToString(dgvGSTR2A3.Rows[e.RowIndex].Cells[cNo].Value).Trim(), cNo))
                            dgvGSTR2A3.Rows[e.RowIndex].Cells[cNo].Value = "";
                    }
                    else if (cNo == "colInvoiceNo" || cNo == "colInvoiceValue" || cNo == "colInvoiceTaxableVal" || cNo == "colIntTax" || cNo == "colCtrlTax" || cNo == "colStateTax" || cNo == "colCessTax") // value
                    {
                        if (chkCellValue(Convert.ToString(dgvGSTR2A3.Rows[e.RowIndex].Cells[cNo].Value).Trim(), cNo))
                        {
                            string[] colNo = { dgvGSTR2A3.Columns[e.ColumnIndex].Name };
                            GetTotal(colNo);
                        }
                        else { dgvGSTR2A3.Rows[e.RowIndex].Cells[cNo].Value = ""; }
                    }
                    else if (cNo == "colReverseCharge")
                    {
                        if (chkCellValue(Convert.ToString(dgvGSTR2A3.Rows[e.RowIndex].Cells[cNo].Value).Trim(), cNo))
                            dgvGSTR2A3.Rows[e.RowIndex].Cells[cNo].Value = "True";
                        else
                            dgvGSTR2A3.Rows[e.RowIndex].Cells[cNo].Value = "False";
                    }
                }
            }
            catch (Exception ex)
        ...
        public bool IsValidateData()
        {
            try
            {
                ...
                string _str = "";
                pbGSTR1.Visible = true;
                dgvGSTR2A3.CurrentCell = dgvGSTR2A3.Rows[0].Cells[0];
                dgvGSTR2A3.AllowUserToAddRows = false;

                #region GSTIN Number
                List<DataGridViewRow> list = dgvGSTR2A3.Rows
                ...
                if (list.Count > 0)
                {
                    ...
                    {
                        dgvGSTR2A3.Rows[list[i].Cells["colGSTIN"].RowIndex].Cells["colGSTIN"].Style.BackColor = Color.Red;
                    }
                    _cnt += 1;
                    _str += _cnt + ") Please enter proper GSTIN of Supplier.\n";
                }
                list = dgvGSTR2A3.Rows
                       .OfType<DataGridViewRow>()
                       .Where(x => true == Utility.IsGSTN(Convert.ToString(x.Cells["colGSTIN"].Value)))
                       .Select(x => x)
                       .ToList();
                for (int i = 0; i < list.Count; i++)
                {
                    dgvGSTR2A3.Rows[list[i].Cells["colGSTIN"].RowIndex].Cells["colGSTIN"].Style.BackColor = Color.White;
                }
                #endregion
                ...
                if (list.Count > 0)
                {
                    for (int i = 0; i < list.Count; i++)
                    {
                        dgvGSTR2A3.Rows[list[i].Cells["colInvoiceDate"].RowIndex].Cells["colInvoiceDate"].Style.BackColor = Color.Red;
                    }
                    _cnt += 1;
                ...
                for (int i = 0; i < list.Count; i++)
                {
                    dgvGSTR2A3.Rows[list[i].Cells["colInvoiceDate"].RowIndex].Cells["colInvoiceDate"].Style.BackColor = Color.White;
                }
                #endregion
                ...
                if (list.Count > 0)
                {
                    for (int i = 0; i < list.Count; i++)
                    {
                        dgvGSTR2A3.Rows[list[i].Cells["colInvoiceValue"].RowIndex].Cells["colInvoiceValue"].Style.BackColor = Color.Red;
                    }
                    _cnt += 1;
                ...
                for (int i = 0; i < list.Count; i++)
                {
                    dgvGSTR2A3.Rows[list[i].Cells["colInvoiceValue"].RowIndex].Cells["colInvoiceValue"].Style.BackColor = Color.White;
                }
                #endregion
                ...
                if (list.Count > 0)
                {
                    for (int i = 0; i < list.Count; i++)
                    {
                        dgvGSTR2A3.Rows[list[i].Cells["colRate"].RowIndex].Cells["colRate"].Style.BackColor = Color.Red;
                    }
                    _cnt += 1;
                ...
                for (int i = 0; i < list.Count; i++)
                {
                    dgvGSTR2A3.Rows[list[i].Cells["colRate"].RowIndex].Cells["colRate"].Style.BackColor = Color.White;
                }
                #endregion
                ...
                if (list.Count > 0)
                {
                    for (int i = 0; i < list.Count; i++)
                    {
                        dgvGSTR2A3.Rows[list[i].Cells["colIntTax"].RowIndex].Cells["colIntTax"].Style.BackColor = Color.Red;
                    }
                    _cnt += 1;
                ...
                for (int i = 0; i < list.Count; i++)
                {
                    dgvGSTR2A3.Rows[list[i].Cells["colIntTax"].RowIndex].Cells["colIntTax"].Style.BackColor = Color.White;
                }
                #endregion
                ...
                if (list.Count > 0)
                {
                    for (int i = 0; i < list.Count; i++)
                    {
                        dgvGSTR2A3.Rows[list[i].Cells["colCtrlTax"].RowIndex].Cells["colCtrlTax"].Style.BackColor = Color.Red;
                    }
                    _cnt += 1;
                ...
                for (int i = 0; i < list.Count; i++)
                {
                    dgvGSTR2A3.Rows[list[i].Cells["colCtrlTax"].RowIndex].Cells["colCtrlTax"].Style.BackColor = Color.White;
                }
                #endregion
                ...
                if (list.Count > 0)
                {
                    for (int i = 0; i < list.Count; i++)
                    {
                        dgvGSTR2A3.Rows[list[i].Cells["colStateTax"].RowIndex].Cells["colStateTax"].Style.BackColor = Color.Red;
                    }
                    _cnt += 1;
                ...
                for (int i = 0; i < list.Count; i++)
                {
                    dgvGSTR2A3.Rows[list[i].Cells["colStateTax"].RowIndex].Cells["colStateTax"].Style.BackColor = Color.White;
                }
                #endregion
                ...
                if (list.Count > 0)
                {
                    for (int i = 0; i < list.Count; i++)
                    {
                        dgvGSTR2A3.Rows[list[i].Cells["colCessTax"].RowIndex].Cells["colCessTax"].Style.BackColor = Color.Red;
                    }
                    _cnt += 1;
                ...
                for (int i = 0; i < list.Count; i++)
                {
                    dgvGSTR2A3.Rows[list[i].Cells["colCessTax"].RowIndex].Cells["colCessTax"].Style.BackColor = Color.White;
                }
                #endregion

                dgvGSTR2A3.AllowUserToAddRows = true;
                pbGSTR1.Visible = false;
                if (_str != "")
                {
        ...
        public void Save()
        {
            try
            {
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    Query = "Delete from SPQR2AInwardSupplies where Fld_Month='" + CommonHelper.SelectedMonth + "' AND Fld_FinancialYear = '" + CommonHelper.ReturnYear + "'"; //and Fld_ReverseCharge ='False'";
                    ...
                    _Result = objGSTR2A.GSTR2A3BulkEntry(dt, Convert.ToString(CommonHelper.StatusText));
                    ...
                    if (_Result == 1)
                    {
                        ...
                        _Result = objGSTR2A.GSTR2A3BulkEntry(dt, "Total");
                        if (_Result == 1)
                        {
                            //DONE
        ...
        public void Delete()
        {
            try
            {
                if (dgvGSTR2A3.CurrentCell.RowIndex == 0 && dgvGSTR2A3.CurrentCell.ColumnIndex == 0)
                {
                    dgvGSTR2A3.CurrentCell = dgvGSTR2A3.Rows[0].Cells[1];
                }
                else { dgvGSTR2A3.CurrentCell = dgvGSTR2A3.Rows[0].Cells[0]; }
                ...
                if (dgvGSTR2A3.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dgvGSTR2A3.Rows.Count; i++)
                    {
                        if (dgvGSTR2A3[0, i].Value != null && dgvGSTR2A3[0, i].Value.ToString() != "")
                        {
                            if (Convert.ToBoolean(dgvGSTR2A3[0, i].Value) == true)
                            {
                                // ADD ROW TO OBJECT IF ROW IS SELECTED
                                flgSelect = true;
                                toDelete.Add(dgvGSTR2A3.Rows[i]);
                            }
                        }
                    }
                    #endregion
                    ...
                    if (flgChk || flgSelect)
                    {
                        ...
                        if (result == DialogResult.Yes)
                        {
                            ...
                            else if (flgSelect == true)
                            {
                                ...
                                {
                                    dgvGSTR2A3.Rows.RemoveAt(row.Index);
                                    Application.DoEvents();
                                }
                            }
                            ...
                            for (int i = 0; i < dgvGSTR2A3.Rows.Count - 1; i++)
                            {
                                dgvGSTR2A3.Rows[i].Cells["colSequence"].Value = Convert.ToString(i + 1);
                            }

                            if (dgvGSTR2A3.Rows.Count == 1)
                            {
                            ...
                            dgvGSTR2A3.Columns[0].HeaderText = "Check All";
                            #endregion
                        }
                    }
            ...
            try
            {
                ...
                if (file.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    ...
                    if (fileExt.CompareTo(".xls") == 0 || fileExt.CompareTo(".xlsx") == 0)
                    {
                        ...
                        DataTable dt = new DataTable();
                        dt = (DataTable)dgvGSTR2A3.DataSource;
            ...
            using (OleDbConnection con = new OleDbConnection(conn))
            {
                try
                {
                    try
                    {
                        ...
                        OleDbDataAdapter oleAdpt = new OleDbDataAdapter("select * from [B2BA_2A3$]", con);
                    ...
                    if (dtexcel != null && dtexcel.Rows.Count > 0)
                    {
                        ...
                        for (int i = 1; i < dgvGSTR2A3.Columns.Count; i++)
                        {
                            Boolean flg = false;
                            for (int j = 0; j < dtexcel.Columns.Count; j++)
                            {
                                // CHECK GRID COLUMN IS PRESENT OR NOT IN IMPORTED EXCEL
                                if (dgvGSTR2A3.Columns[i].HeaderText.Replace(".", "#").Replace(" ", "").ToLower().Trim().Length >= 40)
                                {
                                    string piece = dgvGSTR2A3.Columns[i].HeaderText.Replace(".", "#").Replace(" ", "").ToLower().Trim().Substring(0, 40);
                                    ...
                                    if (piece == piece1)
                                    {
                                        ...
                                        flg = true;
                                        dtexcel.Columns[j].SetOrdinal(dgvGSTR2A3.Columns[i].Index - 1);
                                        break;
                                    }
                                }
                                else if (dgvGSTR2A3.Columns[i].HeaderText.Replace(".", "#").Replace(" ", "").ToLower().Trim() == dtexcel.Columns[j].ColumnName.Replace(" ", "").ToLower().Trim())
                                {
                                    // IF GRID COLUMN PRESENT IN EXCEL THEN ITS INDEX AS PAR GRID COLUMN INDEX
                                    flg = true;
                                    dtexcel.Columns[j].SetOrdinal(dgvGSTR2A3.Columns[i].Index - 1);
                        ...
                        if (dtexcel.Columns.Count >= dgvGSTR2A3.Columns.Count - 2)
                        {
                            for (int i = dtexcel.Columns.Count - 1; i > (dgvGSTR2A3.Columns.Count - 2); i--)
                            {
        ...
        public void ExportExcel()
        {
            try
            {
                if (dgvGSTR2A3.Rows.Count > 0)
                {
                    ...
                    for (int i = 1; i < dgvGSTR2A3.Columns.Count; i++)
                    {
                        newWS.Cells[1, i] = dgvGSTR2A3.Columns[i].HeaderText.ToString();
                    ...
                    Excel.Range headerRange = (Excel.Range)newWS.get_Range((Excel.Range)newWS.Cells[1, 1], (Excel.Range)newWS.Cells[1, dgvGSTR2A3.Columns.Count - 1]);
                    ...
                    object[,] arr = new object[dgvGSTR2A3.Rows.Count, dgvGSTR2A3.Columns.Count];
                    ...
                    if (CommonHelper.IsLicence)
                    {
                        ...
                        for (int i = 0; i < dgvGSTR2A3.Rows.Count; i++)
                        {
                            for (int j = 1; j < dgvGSTR2A3.Columns.Count; j++)
                            {
                                if (j == 5)
                                {
                                    try
                                    {
                                        DateTime ss = Convert.ToDateTime(dgvGSTR2A3.Rows[i].Cells[j].Value);
                                ...
                                else
                                {
                                    ...
                                    arr[i, j - 1] = Convert.ToString(dgvGSTR2A3.Rows[i].Cells[j].Value);
                                }
                            }
                        }
                    }
                    ...
                    Excel.Range bottom = (Excel.Range)newWS.Cells[dgvGSTR2A3.Rows.Count + 1, dgvGSTR2A3.Columns.Count];
        ...
        private DataTable GetDataTabletFromCSVFile(string csv_file_path, DataTable grdData)
        {
            ...
            using (TextFieldParser csvReader = new TextFieldParser(csv_file_path))
            {
                try
                {
                        ...
                        for (int j = 0; j < csvData.Columns.Count; j++)
                        {
                            ...
                            if (dgvGSTR2A3.Columns[i].HeaderText.Replace(".", "#").Replace(" ", "").ToLower().Trim().Length >= 40)
                            {
                                ...
                                if (piece == piece1)
                                {
                                    // if grid column present in excel then its index as par grid column index
                                    flg = true;
                                    csvData.Columns[j].SetOrdinal(dgvGSTR2A3.Columns[i].Index - 1);
                                    break;
                                }
                            }
                            else if (dgvGSTR2A3.Columns[i].HeaderText.Replace(" ", "") == csvData.Columns[j].ColumnName.Replace(" ", "").Trim())
                            {
                                // IF GRID COLUMN PRESENT IN EXCEL THEN ITS INDEX AS PAR GRID COLUMN INDEX
                                flg = true;
                                csvData.Columns[j].SetOrdinal(dgvGSTR2A3.Columns[i].Index - 1);
                    ...
                    if (csvData.Columns.Count >= dgvGSTR2A3.Columns.Count - 2)
                    {
                        for (int i = csvData.Columns.Count - 1; i > (dgvGSTR2A3.Columns.Count - 2); i--)
                        {
        ...
        public void ExportCSV()
        {
            try
            {
                if (dgvGSTR2A3.Rows.Count > 1)
                {
                    ...
                    for (int i = 1; i < dgvGSTR2A3.Columns.Count; i++)
                    {
                        csv += dgvGSTR2A3.Columns[i].HeaderText + ',';
                    }
        ...
        public void ExportPDF()
        {
            try
            {
                if (dgvGSTR2A3.Rows.Count > 1)
                {
                    ...
                    PdfPTable pdfTable = new PdfPTable(dgvGSTR2A3.ColumnCount - 1);
                    ...
                    int i = 0;
                    foreach (DataGridViewColumn column in dgvGSTR2A3.Columns)
                    {
                        if (i != 0)
                        {
                    ...
                    {
                        // FOR LICENCE ALLOWS TO EXPORT ALL RECORDS
                        foreach (DataGridViewRow row in dgvGSTR2A3.Rows)
                        {
                            i = 0;
        ...
        public PdfPTable AssignHeader(PdfPTable pdfTable, string HeaderName)
        {
            try
            {
                ...
                ce1.Colspan = dgvGSTR2A3.Columns.Count;
                ...
                ce2.Colspan = dgvGSTR2A3.Columns.Count;
                ce2.BorderWidth = 0;
        ...
        public void SetGridViewColor()
        {
            try
            {
                ...
                dgvGSTR2A3.AutoGenerateColumns = false;
                dgvGSTR2A3.AllowUserToAddRows = false;
                ...
                this.dgvGSTR2A3.Width = Convert.ToInt32(Screen.PrimaryScreen.WorkingArea.Width * (0.96));
                this.dgvGSTR2A3Total.Width = Convert.ToInt32(Screen.PrimaryScreen.WorkingArea.Width * (0.96));

                // set height of main grid
                this.dgvGSTR2A3.Height = Convert.ToInt32(Screen.PrimaryScreen.WorkingArea.Height * (0.65));

                // set location of header,loading pic, checkbox and main and total grid
               // this.pnlHeader.Location = new System.Drawing.Point(12, 0);
               // this.dgvGSTR2A3.Location = new System.Drawing.Point(12, Convert.ToInt32(Screen.PrimaryScreen.WorkingArea.Height * (0.05)));
               ...
               // this.ckboxHeader.Location = new System.Drawing.Point(32, Convert.ToInt32(Screen.PrimaryScreen.WorkingArea.Height * (0.135)));
                ...
                dgvGSTR2A3.EnableHeadersVisualStyles = false;
                dgvGSTR2A3.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(23, 196, 187);
                dgvGSTR2A3.ColumnHeadersDefaultCellStyle.ForeColor = Color.Black;

                this.dgvGSTR2A3.CellBorderStyle = DataGridViewCellBorderStyle.Single;
                this.dgvGSTR2A3.RowHeadersBorderStyle = DataGridViewHeaderBorderStyle.Single;
                this.dgvGSTR2A3.ColumnHeadersBorderStyle = DataGridViewHeaderBorderStyle.Single;
        ...
        private void txtSearch_TextChanged(object sender, EventArgs e)
        {
            try
            {
                DataTable dt = (DataTable)dgvGSTR2A3.DataSource;
                if (dt == null || dt.Rows.Count == 0)
                {
                ...
                {
                    ((DataTable)dgvGSTR2A3.DataSource).DefaultView.RowFilter = string.Format("colSequence like '%{0}%' or colGSTIN like '%{0}%' or colName like '%{0}%' or colInvoiceNo like '%{0}%' or colInvoiceDate like '%{0}%' or colInvoiceValue like '%{0}%' or colRate like '%{0}%' or colInvoiceTaxableVal like '%{0}%' or colIntTax like '%{0}%' or colCtrlTax like '%{0}%' or colStateTax like '%{0}%' or colCessTax like '%{0}%' or colPOS like '%{0}%'", txtSearch.Text.Trim().Replace("'", "''"));
                }
                else
                {
                    ((DataTable)dgvGSTR2A3.DataSource).DefaultView.RowFilter = string.Format("" + cmbFilter.SelectedValue + " like '%{0}%'", txtSearch.Text.Trim().Replace("'", "''"));
                }
            }
            catch (Exception ex)
            {
        ...
        private void dgvGSTR2A4_UserAddedRow(object sender, DataGridViewRowEventArgs e)
        {
            try
            {
                ...
                dgvGSTR2A3.Rows[e.Row.Index - 1].Cells[1].Value = e.Row.Index;
            }
            catch (Exception ex)
            {
                MessageBox.Show("Error : " + ex.Message);
        ...
        private void dgvGSTR2A4_UserDeletingRow(object sender, DataGridViewRowCancelEventArgs e)
        {
            try
            {
                ...
                for (int i = e.Row.Index; i < dgvGSTR2A3.Rows.Count - 1; i++)
                {
                    dgvGSTR2A3.Rows[i].Cells["colSequence"].Value = i;
                }
        ...
        private void dgvGSTR2A4_Scroll(object sender, ScrollEventArgs e)
        {
            try
            {
                ...
                this.dgvGSTR2A3Total.HorizontalScrollingOffset = this.dgvGSTR2A3.HorizontalScrollingOffset;
            }
            catch (Exception ex)
            {
                MessageBox.Show("Error : " + ex.Message);
        ...
        private void dgvGSTR2A4Total_Scroll(object sender, ScrollEventArgs e)
        {
            ...
            {
                // SET TOTAL GRID OFFSET AS PAR MAIN GRID SCROLL
                this.dgvGSTR2A3.HorizontalScrollingOffset = this.dgvGSTR2A3Total.HorizontalScrollingOffset;
            }
            catch (Exception ex)
            {
                MessageBox.Show("Error : " + ex.Message);
        ...
        private void dgvGSTR2A4_ColumnHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            try
            {
                ...
                if (e.ColumnIndex == 0 && dgvGSTR2A3.Rows.Count > 1)
                {
                    // CHECK AND UNCHECK CHECK BOX OF HEADER FOR SELECTING AND UNSELECTING ALL RECORDS
                    if (dgvGSTR2A3.Columns[e.ColumnIndex].HeaderText == "Check All")
                        ckboxHeader.Checked = true;
                    else if (dgvGSTR2A3.Columns[e.ColumnIndex].HeaderText == "Uncheck All")
                        ckboxHeader.Checked = false;
                }
            }
            catch (Exception ex)
            ...
            try
            {
                ...
                if (dgvGSTR2A3.Rows.Count > 0)
                {
                    if (ckboxHeader.Checked)
                    {
                        ...
                        for (int i = 0; i < dgvGSTR2A3.Rows.Count; i++)
                        {
                            dgvGSTR2A3.Rows[i].Cells[0].Value = "True";
                            Application.DoEvents();
                        }

                        // CHANGE HEADER TEXT
                        dgvGSTR2A3.Columns[0].HeaderText = "Uncheck All";
                        pbGSTR1.Visible = false;
                    }
                    else if (ckboxHeader.Checked == false)
                    {
                        ...
                        for (int i = 0; i < dgvGSTR2A3.Rows.Count; i++)
                        {
                            dgvGSTR2A3.Rows[i].Cells[0].Value = "False";
                            Application.DoEvents();
                        }
                        // CHANGE HEADER TEXT
                        dgvGSTR2A3.Columns[0].HeaderText = "Check All";
        ...
        public void JSONCreator()
        {
            try
            {
                ...
                List<string> list = dgvGSTR2A3.Rows
                       .OfType<DataGridViewRow>()
                ...
                if (list != null && list.Count > 0)
                {
                    ...
                    B2b b2bObj = new B2b();
                    b2bObj.ctin = Convert.ToString(dgvGSTR2A3.Rows[0].Cells[2].Value);
                    obj.Add(b2bObj);
                    ...
                    for (int i = 0; i < list.Count; i++)
                    {
                        if (list[i] != "")
                        {
                            ...
                            List<DataGridViewRow> Invoicelist = dgvGSTR2A3.Rows
                                   .OfType<DataGridViewRow>()
        ...
        public void ValidataAndGetGSTIN()
        {
            try
            {
                ...
                {
                    pbGSTR1.Visible = true;
                    new PrefillHelper().GetNameByGSTIN(dgvGSTR2A3, "colGSTIN", "colName");
