...
{
    public partial class SPQGSTR4A6A : Form
    {
        ...
        private void GetData()
        {
            try
            {
                ...
                string Query = "Select * from GSTR4AFormPartA6A where Fld_Month='" + CommonHelper.SelectedMonth + "' AND Fld_FinancialYear = '" + CommonHelper.ReturnYear + "' and Fld_FileStatus != 'Total'";
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    foreach (DataGridViewColumn col in dgvGSTR4A6A.Columns)
                    {
        ...
        public void GetTotal(int[] colNo)
        {
            try
            {
                if (dgvGSTR4A6A.Rows.Count > 1)
                {
                    // IF MAIN GRID HAVING RECORDS

                    if (dgvGSTR4A6ATotal.Rows.Count == 0)
                    {
                        ...
                        foreach (DataGridViewColumn col in dgvGSTR4A6ATotal.Columns)
                        {
                        ...
                        dr["colTIGSTAmt"] = dgvGSTR4A6A.Rows.Cast<DataGridViewRow>().Where(x => x.Cells[10].Value != null).Sum(x => x.Cells[10].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells[10].Value)).ToString();
                        dr["colTCGSTAmt"] = dgvGSTR4A6A.Rows.Cast<DataGridViewRow>().Where(x => x.Cells[12].Value != null).Sum(x => x.Cells[12].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells[12].Value)).ToString();
                        dr["colTSGSTAmt"] = dgvGSTR4A6A.Rows.Cast<DataGridViewRow>().Where(x => x.Cells[14].Value != null).Sum(x => x.Cells[14].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells[14].Value)).ToString();
                        ...
                        dgvGSTR4A6ATotal.DataSource = dtTotal;

                        #endregion
                    }
                    else if (dgvGSTR4A6ATotal.Rows.Count == 1)
                    {
                        ...
                        {
                            if (item == 10)
                                dgvGSTR4A6ATotal.Rows[0].Cells[10].Value = dgvGSTR4A6A.Rows.Cast<DataGridViewRow>().Where(x => x.Cells[10].Value != null).Sum(x => x.Cells[10].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells[10].Value)).ToString();
                            else if (item == 12)
                                dgvGSTR4A6ATotal.Rows[0].Cells[12].Value = dgvGSTR4A6A.Rows.Cast<DataGridViewRow>().Where(x => x.Cells[12].Value != null).Sum(x => x.Cells[12].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells[12].Value)).ToString();
                            else if (item == 14)
                                dgvGSTR4A6ATotal.Rows[0].Cells[14].Value = dgvGSTR4A6A.Rows.Cast<DataGridViewRow>().Where(x => x.Cells[14].Value != null).Sum(x => x.Cells[14].Value.ToString().Trim() == "" ? 0 : Convert.ToDecimal(x.Cells[14].Value)).ToString();
                        }
                        #endregion
                    }

                    // SET GRID ROW HEIGHT AND ASSIGN TOTAL HEADER
                    dgvGSTR4A6ATotal.Rows[0].Cells[0].Value = "TOTAL";
                }
                else
                {
        ...
        private void dgvGSTR4A6A_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                if (e.KeyCode == Keys.Delete)
                {
                    ...
                    try
                    {
                        ...
                        if (dgvGSTR4A6A.Rows.Count > 0)
                        {
                            // DELETE SELECTED CELL IN GRID
                            foreach (DataGridViewCell oneCell in dgvGSTR4A6A.SelectedCells)
                            {
                ...
                if (e.KeyCode == Keys.V)
                {
                    ...
                    if (dgvGSTR4A6A.RowCount > 0) // IF GRID IS NOT NULL AND PAST ONLY ON SELECTED CELLS
                    {
                        foreach (DataGridViewCell oneCell in dgvGSTR4A6A.SelectedCells)
                        {
                            if (oneCell.Selected)
                    ...
                    foreach (string line in lines)
                    {
                        ...
                        {
                            // disable main grid
                            DisableControls(dgvGSTR4A6A);

                            gRowNo = dgvGSTR4A6A.Rows.Count - 1;
                            int no = tmp;

                            if (iRow > gRowNo - 1)
                            {
                                DataTable dtDGV = new DataTable();
                                //dtDGV = dgvGSTR4A6A.DataSource as DataTable;
                                ...
                                foreach (DataGridViewRow dr in dgvGSTR4A6A.Rows)
                                {
                                    if (dr.Index != dgvGSTR4A6A.Rows.Count - 1) // DON'T ADD LAST ROW
                                    {
                                        // SET CHECK BOX VALUE
                                        rowValue[0] = "False";
                            ...
                            else
                            {
                                ...
                                if (line.Length > 0)
                                {
                                    ...
                                    for (int i = 0; i < sCells.GetLength(0); ++i)
                                    {
                                        ...
                                        if (iCol + i < this.dgvGSTR4A6A.ColumnCount && i < 13)
                                        {
                                            // SKIP CHECK BOX COLUMN AND SEQUANCE COLUMN TO PASTE DATA
                                            if (iCol == 0)
                                                oCell = dgvGSTR4A6A[iCol + i + 2, iRow];
                                            else if (iCol == 1)
                                                oCell = dgvGSTR4A6A[iCol + i + 1, iRow];
                                            else
                                                oCell = dgvGSTR4A6A[iCol + i, iRow];

                                            sCells[i] = sCells[i].Trim().Replace(",", "");
                                            if (oCell.ColumnIndex != 0)
                                            {
                                                if (dgvGSTR4A6A.Columns[oCell.ColumnIndex].Name != "colChk" && dgvGSTR4A6A.Columns[oCell.ColumnIndex].Name != "colSequence")
                                                {
                                                    #region VALIDATION
                                                    if (sCells[i].ToString().Trim() == "") { dgvGSTR4A6A.Rows[iRow].Cells[oCell.ColumnIndex].Value = DBNull.Value; }
                                                    else
                                                    {
                                                        if (oCell.ColumnIndex >= 2 && oCell.ColumnIndex <= 14)
                                                        {
                                                            if (chkCellValue(sCells[i].Trim(), oCell.ColumnIndex))
                                                                dgvGSTR4A6A.Rows[iRow].Cells[oCell.ColumnIndex].Value = sCells[i].Trim();
                                                            else
                                                                dgvGSTR4A6A.Rows[iRow].Cells[oCell.ColumnIndex].Value = DBNull.Value;
                                                        }
                                                        else { dgvGSTR4A6A.Rows[iRow].Cells[oCell.ColumnIndex].Value = sCells[i].Trim(); }
                                                    }
                                                    #endregion
                                                }
                                            }
                                            else
                                            {
                                                if (iCol > i)
                                                {
                                                    for (int j = oCell.ColumnIndex; j < dgvGSTR4A6A.Columns.Count; j++)
                                                    {
                                                        #region VALIDATION
                                                        if (sCells[i].ToString().Trim() == "") { dgvGSTR4A6A.Rows[iRow].Cells[j].Value = DBNull.Value; }
                                                        else
                                                        {
                                                            if (j >= 2 && j <= 14)
                                                            {
                                                                if (chkCellValue(sCells[i].Trim(), j))
                                                                    dgvGSTR4A6A.Rows[iRow].Cells[j].Value = sCells[i].Trim();
                                                                else
                                                                    dgvGSTR4A6A.Rows[iRow].Cells[j].Value = DBNull.Value;
                                                            }
                                                            else { dgvGSTR4A6A.Rows[iRow].Cells[j].Value = sCells[i].Trim(); }
                                                        }
                                                        #endregion
                    ...
                    for (int i = 0; i < dgvGSTR4A6A.Rows.Count - 1; i++)
                    {
                        dgvGSTR4A6A.Rows[i].Cells["colSequence"].Value = i + 1;
                    }
                    #endregion

                    // enable control
                    EnableControls(dgvGSTR4A6A);
                }
                ...
                foreach (string line in lines)
                {
                    ...
                    if (cnt >= lineNo)
                    {
                        if (line != "" && line.Length > 0)
                        {
                            ...
                            {
                                // CHECK GRID COLUMN COUNT
                                if (iCol + i < this.dgvGSTR4A6A.ColumnCount && colNo < 14)
                                {
                                    // SKIP CHECK BOX COLUMN AND SEQUANCE COLUMN TO PASTE DATA
                                    if (iCol == 0)
                                        colNo = iCol + i + 2;
                                    ...
                                    else
                                    {
                                        ...
                                        if (iCol > i)
                                        {
                                            for (int j = colNo; j < dgvGSTR4A6A.Columns.Count; j++)
                                            {
                                                #region VALIDATION
        ...
        public bool IsValidateData()
        {
            try
            {
                int _cnt = 0, sj = 0;
                string _str = "";
                dgvGSTR4A6A.CurrentCell = dgvGSTR4A6A.Rows[0].Cells[0];
                dgvGSTR4A6A.AllowUserToAddRows = false;

                #region GSTN Number
                sj = 2;
                List<DataGridViewRow> list = dgvGSTR4A6A.Rows
                ...
                if (list.Count > 0)
                {
                    ...
                    {
                        dgvGSTR4A6A.Rows[list[i].Cells[sj].RowIndex].Cells[sj].Style.BackColor = Color.Red;
                    }
                    _cnt += 1;
                    _str += _cnt + ") Please enter proper GSTN of supplier.\n";
                }
                list = dgvGSTR4A6A.Rows
                       .OfType<DataGridViewRow>()
                       .Where(x => true == Utility.IsGSTN(Convert.ToString(x.Cells[sj].Value)))
                       .Select(x => x)
                       .ToList();
                for (int i = 0; i < list.Count; i++)
                {
                    dgvGSTR4A6A.Rows[list[i].Cells[sj].RowIndex].Cells[sj].Style.BackColor = Color.White;
                }
                #endregion
                ...
                if (list.Count > 0)
                {
                    for (int i = 0; i < list.Count; i++)
                    {
                        dgvGSTR4A6A.Rows[list[i].Cells["colTypeOfNote"].RowIndex].Cells["colTypeOfNote"].Style.BackColor = Color.Red;
                    }
                    _cnt += 1;
                ...
                for (int i = 0; i < list.Count; i++)
                {
                    dgvGSTR4A6A.Rows[list[i].Cells["colTypeOfNote"].RowIndex].Cells["colTypeOfNote"].Style.BackColor = Color.White;
                }
                #endregion
                ...
                #region Original /Revised Debit Note/ credit note Date
                sj = 7;
                list = null;//dd-MM-yyyy
                list = dgvGSTR4A6A.Rows
                       .OfType<DataGridViewRow>()
                ...
                if (list.Count > 0)
                {
                    ...
                    _cnt += 1;
                    _str += _cnt + ") Please enter proper original/ revised debit note/ credit note date.\n";
                }
                list = dgvGSTR4A6A.Rows
                       .OfType<DataGridViewRow>()
                       .Where(x => true == Utility.IsDate(Convert.ToString(x.Cells[sj].Value)))
                ...
                dgvGSTR4A6A.AllowUserToAddRows = true;
        ...
        private void dgvGSTR4A6A_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                if (e.RowIndex >= 0)
                {
                    ...
                    {
                        if (!chkCellValue(Convert.ToString(dgvGSTR4A6A.Rows[e.RowIndex].Cells[cNo].Value).Trim(), cNo))
                            dgvGSTR4A6A.Rows[e.RowIndex].Cells[cNo].Value = "";
                    }
                    else if (cNo == 10 || cNo == 12 || cNo == 14) // value
                    {
                        if (chkCellValue(Convert.ToString(dgvGSTR4A6A.Rows[e.RowIndex].Cells[cNo].Value).Trim(), cNo))
                        ...
                        else { dgvGSTR4A6A.Rows[e.RowIndex].Cells[cNo].Value = ""; }
                    }
                    else
                    {
        ...
        public void Save()
        {
            try
            {
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    Query = "Delete from GSTR4AFormPartA6A where Fld_Month='" + CommonHelper.SelectedMonth + "' AND Fld_FinancialYear = '" + CommonHelper.ReturnYear + "'";
                    ...
                    _Result = objGSTR4A.GSTR4A6ABulkEntry(dt, Convert.ToString(CommonHelper.StatusText));
                    ...
                    if (_Result == 1)
                    {
                        ...
                        if (dgvGSTR4A6ATotal.Rows.Count == 1)
                        {
                            foreach (DataGridViewRow dr in dgvGSTR4A6ATotal.Rows)
                            {
                                for (int i = 0; i < dr.Cells.Count; i++)
                                {
                        ...
                        _Result = objGSTR4A.GSTR4A6ABulkEntry(dt, "Total");
        ...
        public void Delete()
        {
            try
            {
                ...
                if (dgvGSTR4A6A.CurrentCell.RowIndex == 0 && dgvGSTR4A6A.CurrentCell.ColumnIndex == 0)
                {
                    dgvGSTR4A6A.CurrentCell = dgvGSTR4A6A.Rows[0].Cells[1];
                }
                else { dgvGSTR4A6A.CurrentCell = dgvGSTR4A6A.Rows[0].Cells[0]; }
                ...
                if (dgvGSTR4A6A.Rows.Count > 1)
                {
                    ...
                    for (int i = 0; i < dgvGSTR4A6A.Rows.Count - 1; i++)
                    {
                        if (dgvGSTR4A6A[0, i].Value != null && dgvGSTR4A6A[0, i].Value.ToString() != "")
                        {
                            if (Convert.ToBoolean(dgvGSTR4A6A[0, i].Value) == true)
                            {
                                // ADD ROW TO OBJECT IF ROW IS SELECTED
                                flgSelect = true;
                                toDelete.Add(dgvGSTR4A6A.Rows[i]);
                            }
                        }
                    }
                    #endregion
                    ...
                    if (flgChk || flgSelect)
                    {
                        ...
                        if (result == DialogResult.Yes)
                        {
                            ...
                            else if (flgSelect == true)
                            {
                                ...
                                {
                                    dgvGSTR4A6A.Rows.RemoveAt(row.Index);
                                    Application.DoEvents();
                            ...
                            for (int i = 0; i < dgvGSTR4A6A.Rows.Count - 1; i++)
                            {
                                dgvGSTR4A6A.Rows[i].Cells["colSequence"].Value = Convert.ToString(i + 1);
                            }
                            ...
                            dgvGSTR4A6A.Columns[0].HeaderText = "Check All";
                            #endregion
                        }
                    }
            ...
            try
            {
                ...
                if (file.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    ...
                    if (fileExt.CompareTo(".xls") == 0 || fileExt.CompareTo(".xlsx") == 0)
                    {
                        ...
                        DataTable dt = new DataTable();
                        dt = (DataTable)dgvGSTR4A6A.DataSource;
                        ...
                        if (dtExcel.Columns.Count != 1)
                        {
                            ...
                            else
                            {
                                ...
                                if (dtExcel != null && dtExcel.Rows.Count > 0)
                                {
                                    ...
                                    dgvGSTR4A6A.DataSource = dtExcel;
            ...
            using (OleDbConnection con = new OleDbConnection(conn))
            {
                try
                {
                    try
                    {
                        ...
                        OleDbDataAdapter oleAdpt = new OleDbDataAdapter("select * from [B2B_4A6A$]", con);
                    ...
                    if (dtexcel != null && dtexcel.Rows.Count > 0)
                    {
                        ...
                        for (int i = 1; i < dgvGSTR4A6A.Columns.Count; i++)
                        {
                            Boolean flg = false;
                            for (int j = 0; j < dtexcel.Columns.Count; j++)
                            {
                                // CHECK GRID COLUMN IS PRESENT OR NOT IN IMPORTED EXCEL
                                if (dgvGSTR4A6A.Columns[i].HeaderText.Replace(".", "#").Replace(" ", "").ToLower().Trim() == dtexcel.Columns[j].ColumnName.Replace(" ", "").ToLower().Trim())
                                {
                                    // IF GRID COLUMN PRESENT IN EXCEL THEN ITS INDEX AS PAR GRID COLUMN INDEX
                                    flg = true;
                                    dtexcel.Columns[j].SetOrdinal(dgvGSTR4A6A.Columns[i].Index - 1);
                                    break;
                                }
                            }
                            if (flg == false)
                        ...
                        if (dtexcel.Columns.Count >= dgvGSTR4A6A.Columns.Count - 2)
                        {
                            for (int i = dtexcel.Columns.Count - 1; i > (dgvGSTR4A6A.Columns.Count - 2); i--)
                            {
        ...
        public void ExportExcel()
        {
            try
            {
                if (dgvGSTR4A6A.Rows.Count > 1)
                {
                    ...
                    for (int i = 1; i < dgvGSTR4A6A.Columns.Count; i++)
                    {
                        newWS.Cells[1, i] = dgvGSTR4A6A.Columns[i].HeaderText.ToString();
                    ...
                    Excel.Range headerRange = (Excel.Range)newWS.get_Range((Excel.Range)newWS.Cells[1, 1], (Excel.Range)newWS.Cells[1, dgvGSTR4A6A.Columns.Count - 1]);
                    ...
                    object[,] arr = new object[dgvGSTR4A6A.Rows.Count - 1, dgvGSTR4A6A.Columns.Count];
                    ...
                    if (CommonHelper.IsLicence)
                    {
                        ...
                        for (int i = 0; i < dgvGSTR4A6A.Rows.Count - 1; i++)
                        {
                            ...
                            ProgressBar.Visible = true;
                            if (i == 0)
                                load(true, dgvGSTR4A6A.Rows.Count - 1, i.ToString());
                            else
                                load(false, dgvGSTR4A6A.Rows.Count - 1, i.ToString());

                            for (int j = 1; j < dgvGSTR4A6A.Columns.Count; j++)
                            {
                                arr[i, j - 1] = dgvGSTR4A6A.Rows[i].Cells[j].Value.ToString();
                            }
                        }
                    }
                    else
                    ...
                    Excel.Range bottom = (Excel.Range)newWS.Cells[dgvGSTR4A6A.Rows.Count, dgvGSTR4A6A.Columns.Count];
            ...
            using (TextFieldParser csvReader = new TextFieldParser(csv_file_path))
            {
                try
                {
                    ...
                    for (int i = 1; i < dgvGSTR4A6A.Columns.Count; i++)
                    {
                        ...
                        {
                            // CHECK GRID COLUMN IS PRESENT OR NOT IN IMPORTED EXCEL
                            if (dgvGSTR4A6A.Columns[i].HeaderText.Replace(" ", "") == csvData.Columns[j].ColumnName.Replace(" ", "").Trim())
                            {
                                // IF GRID COLUMN PRESENT IN EXCEL THEN ITS INDEX AS PAR GRID COLUMN INDEX
                                flg = true;
                                csvData.Columns[j].SetOrdinal(dgvGSTR4A6A.Columns[i].Index - 1);
                                break;
                            }
                        }
                        if (flg == false)
                    ...
                    if (csvData.Columns.Count >= dgvGSTR4A6A.Columns.Count - 2)
                    {
                        for (int i = csvData.Columns.Count - 1; i > (dgvGSTR4A6A.Columns.Count - 2); i--)
                        {
        ...
        public void ExportCSV()
        {
            try
            {
                if (dgvGSTR4A6A.Rows.Count > 1)
                {
                    ...
                    for (int i = 1; i < dgvGSTR4A6A.Columns.Count; i++)
                    {
                        csv += dgvGSTR4A6A.Columns[i].HeaderText + ',';
                    }
        ...
        public void ExportPDF()
        {
            try
            {
                if (dgvGSTR4A6A.Rows.Count > 1)
                {
                    ...
                    PdfPTable pdfTable = new PdfPTable(dgvGSTR4A6A.ColumnCount - 1);
                    ...
                    pdfTable = AssignHeader(pdfTable, "6A. Amendment to Details of Credit/Debit Notes Issued and Received of earlier tax periods");
                    #endregion

                    #region ADDING HEADER ROW
                    int i = 0;
                    foreach (DataGridViewColumn column in dgvGSTR4A6A.Columns)
                    {
                        if (i != 0)
                        {
                    ...
                    {
                        // FOR LICENCE ALLOWS TO EXPORT ALL RECORDS
                        foreach (DataGridViewRow row in dgvGSTR4A6A.Rows)
                        {
                            i = 0;
                            ...
                            ProgressBar.Visible = true;
                            if (sj == 0)
                                load(true, dgvGSTR4A6A.Rows.Count - 1, sj.ToString());
                            else
                                load(false, dgvGSTR4A6A.Rows.Count - 1, sj.ToString());
        ...
        public PdfPTable AssignHeader(PdfPTable pdfTable, string HeaderName)
        {
            try
            {
                ...
                ce1.Colspan = dgvGSTR4A6A.Columns.Count;
                ...
                ce2.Colspan = dgvGSTR4A6A.Columns.Count;
                ce2.BorderWidth = 0;
        ...
        public void SetGridViewColor()
        {
            try
            {
                ...
                dgvGSTR4A6A.AutoGenerateColumns = false;
                ...
                this.dgvGSTR4A6A.Width = Convert.ToInt32(Screen.PrimaryScreen.WorkingArea.Width * (0.96));
                this.dgvGSTR4A6ATotal.Width = Convert.ToInt32(Screen.PrimaryScreen.WorkingArea.Width * (0.96));

                // SET HEIGHT OF MAIN GRID
                this.dgvGSTR4A6A.Height = Convert.ToInt32(Screen.PrimaryScreen.WorkingArea.Height * (0.65));
                this.dgvGSTR4A6ATotal.Height = 40;

                // SET LOCATION OF HEADER,LOADING PIC, CHECKBOX AND MAIN AND TOTAL GRID
                this.panel1.Location = new System.Drawing.Point(12, 0);
                this.dgvGSTR4A6A.Location = new System.Drawing.Point(12, Convert.ToInt32(Screen.PrimaryScreen.WorkingArea.Height * (0.05)));
                this.dgvGSTR4A6ATotal.Location = new System.Drawing.Point(12, Convert.ToInt32(Screen.PrimaryScreen.WorkingArea.Height * (0.71)));
                ...
                dgvGSTR4A6A.EnableHeadersVisualStyles = false;
                dgvGSTR4A6A.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(23, 196, 187);
                dgvGSTR4A6A.ColumnHeadersDefaultCellStyle.ForeColor = Color.Black;

                this.dgvGSTR4A6A.CellBorderStyle = DataGridViewCellBorderStyle.Single;
                this.dgvGSTR4A6A.RowHeadersBorderStyle = DataGridViewHeaderBorderStyle.Single;
                this.dgvGSTR4A6A.ColumnHeadersBorderStyle = DataGridViewHeaderBorderStyle.Single;
        ...
        private void txtSearch_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ((DataTable)dgvGSTR4A6A.DataSource).DefaultView.RowFilter = string.Format("colSequence like '%{0}%' or col6AGSTIN like '%{1}%' or colTypeOfNote like '%{2}%' or colOrgDbtCrdtNoteNo like '%{3}%' or colOrgDbtCrdtNoteDate like '%{4}%' or colOrgRvsNoteNo like '%{5}%' or colOrgRvsNoteDate like '%{6}%' or col4ADiffValue  like '%{7}%' or col6AIGSTRate like '%{8}%' or col6AIGSTAmt like '%{9}%' or col6ACGSTRate like '%{10}%' or col6ACGSTAmt like '%{11}%' or col6ASGSTRate like '%{12}%' or col6ASGSTAmt like '%{13}%'", txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"), txtSearch.Text.Trim().Replace("'", "''"));
            }
            catch (Exception ex)
            {
                MessageBox.Show("Error : " + ex.Message);
        ...
        private void dgvGSTR4A6A_UserAddedRow(object sender, DataGridViewRowEventArgs e)
        {
            try
            {
                // SET INDEX OF USER ADDED ROW IN MAIN GRID
                dgvGSTR4A6A.Rows[e.Row.Index - 1].Cells[1].Value = e.Row.Index;
            }
            catch (Exception ex)
            {
                MessageBox.Show("Error : " + ex.Message);
        ...
        private void dgvGSTR4A6A_UserDeletingRow(object sender, DataGridViewRowCancelEventArgs e)
        {
            try
            {
                // SET SEQUNCING AFTER USER DELETING ROW IN GRID
                for (int i = e.Row.Index; i < dgvGSTR4A6A.Rows.Count - 1; i++)
                {
                    dgvGSTR4A6A.Rows[i].Cells["colSequence"].Value = i;
                }
                // TOTAL CALCULATION
                int[] colNo = { 10, 12, 14 };
                GetTotal(colNo);
        ...
        private void DisableControls(Control con)
        {
            ...
            {
                if (c.Name != "frmGSTR4A6A" && c.Name != "dgvGSTR4A6ATotal")
                    DisableControls(c);
            }
            con.Enabled = false;
        ...
        private void dgvGSTR4A6A_Scroll(object sender, ScrollEventArgs e)
        {
            try
            {
                // SET TOTAL GRID OFFSET AS PAR MAIN GRID SCROLL
                this.dgvGSTR4A6ATotal.HorizontalScrollingOffset = this.dgvGSTR4A6A.HorizontalScrollingOffset;
            }
            catch (Exception ex)
            {
                MessageBox.Show("Error : " + ex.Message);
        ...
        private void dgvGSTR4A6ATotal_Scroll(object sender, ScrollEventArgs e)
        {
            try
            {
                // SET TOTAL GRID OFFSET AS PAR MAIN GRID SCROLL
                this.dgvGSTR4A6A.HorizontalScrollingOffset = this.dgvGSTR4A6ATotal.HorizontalScrollingOffset;
            }
            catch (Exception ex)
            {
                MessageBox.Show("Error : " + ex.Message);
        ...
        private void dgvGSTR4A6A_ColumnHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            try
            {
                // CHECK FIRST COLUMN HEADER PRESSED AND MAIN GRID HAVING RECORDS
                if (e.ColumnIndex == 0 && dgvGSTR4A6A.Rows.Count > 1)
                {
                    // CHECK AND UNCHECK CHECK BOX OF HEADER FOR SELECTING AND UNSELECTING ALL RECORDS
                    if (dgvGSTR4A6A.Columns[e.ColumnIndex].HeaderText == "Check All")
                        ckboxHeader.Checked = true;
                    else if (dgvGSTR4A6A.Columns[e.ColumnIndex].HeaderText == "Uncheck All")
                        ckboxHeader.Checked = false;
                }
            }
            catch (Exception ex)
            ...
            try
            {
                ...
                if (dgvGSTR4A6A.Rows.Count > 1)
                {
                    ...
                    if (ckboxHeader.Checked)
                    {
                        ...
                        for (int i = 0; i < dgvGSTR4A6A.Rows.Count - 1; i++)
                        {
                            dgvGSTR4A6A.Rows[i].Cells[0].Value = "True";
                            Application.DoEvents();
                        }

                        // CHANGE HEADER TEXT AND WIDTH OF COLUMN AND POSITION OF CHECK BOX OF CHECK ALL COLUMN
                        //dgvGSTR4A6A.Columns[0].DefaultCellStyle.NullValue = true;
                        dgvGSTR4A6A.Columns[0].HeaderText = "Uncheck All";
                    }
                    else if (ckboxHeader.Checked == false)
                    {
                        ...
                        for (int i = 0; i < dgvGSTR4A6A.Rows.Count - 1; i++)
                        {
                            dgvGSTR4A6A.Rows[i].Cells[0].Value = "False";
                            Application.DoEvents();
                        }

                        // CHANGE HEADER TEXT AND WIDTH OF COLUMN AND POSITION OF CHECK BOX OF CHECK ALL COLUMN
                        //dgvGSTR4A6A.Columns[0].DefaultCellStyle.NullValue = false;
                        dgvGSTR4A6A.Columns[0].HeaderText = "Check All";
                    }
                    pbGSTR1.Visible = false;
                }
        ...
        private void dgvGSTR4A6ATotal_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            try
            {
                if (dgvGSTR4A6ATotal.Rows.Count > 0)
                {
                    DataGridViewRow row = this.dgvGSTR4A6ATotal.RowTemplate;
        ...
        private void frmGSTR4A6A_FormClosed(object sender, FormClosedEventArgs e)
        {
